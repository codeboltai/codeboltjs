...
// Tool names constants matching Codebolt conventions or what we expect
export const ACTIVATE_SKILL_TOOL_NAME = 'codebolt_skills--activateSkill';
export const ASK_USER_TOOL_NAME = 'codebolt_utils--askUser';
export const EDIT_TOOL_NAME = 'codebolt_fs--editFile';
export const EXIT_PLAN_MODE_TOOL_NAME = 'codebolt_agent--exitPlanMode';
export const GLOB_TOOL_NAME = 'codebolt_fs--glob';
export const GREP_TOOL_NAME = 'codebolt_fs--grep';
export const MEMORY_TOOL_NAME = 'codebolt_memory--updateMemory';
export const READ_FILE_TOOL_NAME = 'codebolt_fs--readFile';
export const SHELL_TOOL_NAME = 'codebolt_terminal--executeCommand';
export const WRITE_FILE_TOOL_NAME = 'codebolt_fs--writeFile';
export const WRITE_TODOS_TOOL_NAME = 'codebolt_task--updateTask';
