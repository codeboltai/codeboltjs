...
codebolt.onMessage(async (reqMessage: FlatUserMessage, additionalVariable: any) => {
    ...
    try {
        const { result } = {
            result: {
                requirementPlanPath: "/Users/ravirawat/Documents/cbtest/orchestrator-team-test/plans/todo-api-server.plan"
            }
        } //executionResult?.finalMessage ? JSON.parse(executionResult.finalMessage) : {};
