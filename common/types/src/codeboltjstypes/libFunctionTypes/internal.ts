...
import type { PendingRequest } from './common';
...
export interface WebSocketManager {
  websocket: any | null; // WebSocket type
  isConnected: boolean;
...
export interface InternalASTNode {
...
export interface InternalErrorInterface extends Error {
  code: string;
  module: string;
...
export class InternalError extends Error implements InternalErrorInterface {
...
export interface SerializationManager {
  ...
  serialize(data: any, format?: string): string | Uint8Array;
  deserialize(data: string | Uint8Array, format?: string): any;
}
