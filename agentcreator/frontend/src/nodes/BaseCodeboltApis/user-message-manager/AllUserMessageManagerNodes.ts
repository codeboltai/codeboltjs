...
// Frontend GetUserMessageText Node - UI only
...
// Frontend HasCurrentUserMessage Node - UI only
...
// Frontend ClearUserMessage Node - UI only
...
// Frontend GetMentionedFiles Node - UI only
...
// Frontend GetMentionedMCPs Node - UI only
...
// Frontend GetCurrentFile Node - UI only
...
// Frontend GetSelection Node - UI only
...
// Frontend GetRemixPrompt Node - UI only
...
// Frontend GetUploadedImages Node - UI only
...
// Frontend SetUserSessionData Node - UI only
...
// Frontend GetUserSessionData Node - UI only
