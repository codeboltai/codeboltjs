/**
 * Core types and interfaces for the standalone tools framework
 */

//mport type { FunctionDeclaration, Part } from '@google/generative-ai';

/**
 * OpenAI tool schema format - now the primary format
 */
...
// Use a more generic type for LLM content
...
export interface ToolResult {
  ...
  error?: {
    ...
    type?: ToolErrorType; // An optional machine-readable error type
  };
}
...
> {
  ...
  /** Function declaration schema from @google/genai (for backward compatibility) */
