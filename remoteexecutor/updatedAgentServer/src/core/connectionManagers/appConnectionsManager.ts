...
import { FileDeleteConfirmation, FileDeleteSuccess, FileReadConfirmation, FileReadSuccess, FileWriteConfirmation, FileWriteError, FileWriteRejected, FileWriteSuccess, SearchConfirmation, SearchError, SearchInProgress, SearchRejected, SearchSuccess } from '@codebolt/types/wstypes/app-to-ui-ws/fileMessageSchemas';
...
export class AppConnectionsManager {
  ...
  sendToApp(appId: string, message: Message | ReadFileEvent | FileReadConfirmation | FileReadSuccess | FileWriteConfirmation | FileWriteSuccess | FileWriteError | FileDeleteConfirmation | FileDeleteSuccess | SearchSuccess | SearchError | SearchRejected |SearchInProgress |SearchConfirmation  | FileWriteRejected ): boolean {
