...
import { FileDeleteConfirmation, FileDeleteSuccess, FileReadConfirmation, FileReadSuccess, FileWriteConfirmation, FileWriteError, FileWriteSuccess } from '@codebolt/types/wstypes/app-to-ui-ws/fileMessageSchemas';
...
export class AppConnectionsManager {
  ...
  sendToApp(appId: string, message: Message | ReadFileEvent | FileReadConfirmation | FileReadSuccess | FileWriteConfirmation | FileWriteSuccess | FileWriteError | FileDeleteConfirmation | FileDeleteSuccess): boolean {
