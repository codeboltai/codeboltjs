...
Defined in: [packages/agent/src/unified/types/libTypes.ts:273](packages/agent/src/unified/types/libTypes.ts#L273)
...
| <a id="conversationhistory"></a> `conversationHistory` | [`OpenAIMessage`](OpenAIMessage.md)[] | Complete conversation history | [packages/agent/src/unified/types/libTypes.ts:279](packages/agent/src/unified/types/libTypes.ts#L279) |
...
| <a id="toolresults"></a> `toolResults` | [`ToolResult`](ToolResult.md)[] | Tool execution results | [packages/agent/src/unified/types/libTypes.ts:281](packages/agent/src/unified/types/libTypes.ts#L281) |
