...
Defined in: [packages/agent/src/unified/types/libTypes.ts:173](packages/agent/src/unified/types/libTypes.ts#L173)
...
| <a id="chat"></a> `chat` | \{ `clearHistory`: `Promise`\<`void`\>; `getHistory`: `Promise`\<[`OpenAIMessage`](OpenAIMessage.md)[]\>; `sendMessage`: `Promise`\<`void`\>; `summarizeConversation`: `Promise`\<`string`\>; \} | Chat operations | [packages/agent/src/unified/types/libTypes.ts:175](packages/agent/src/unified/types/libTypes.ts#L175) |
...
| `chat.getHistory` | `Promise`\<[`OpenAIMessage`](OpenAIMessage.md)[]\> | - | [packages/agent/src/unified/types/libTypes.ts:179](packages/agent/src/unified/types/libTypes.ts#L179) |
...
| <a id="mcp"></a> `mcp` | \{ `executeTool`: `Promise`\<\{ `data`: `unknown`; \}\>; `getToolSchema`: `Promise`\<[`OpenAITool`](OpenAITool.md)\>; `listTools`: `Promise`\<`string`[]\>; \} | MCP (Micro-Component Platform) operations | [packages/agent/src/unified/types/libTypes.ts:198](packages/agent/src/unified/types/libTypes.ts#L198) |
...
| `mcp.getToolSchema` | `Promise`\<[`OpenAITool`](OpenAITool.md)\> | - | [packages/agent/src/unified/types/libTypes.ts:204](packages/agent/src/unified/types/libTypes.ts#L204) |
