...
Defined in: [ProviderTypes.ts:65](packages/provider/src/lib/ProviderTypes.ts#L65)
...
| <a id="onproviderstart"></a> `onProviderStart` | (`vars`: `ProviderInitVars`) => `Promise`\<[`ProviderStartResult`](ProviderStartResult.md)\> | [ProviderTypes.ts:66](packages/provider/src/lib/ProviderTypes.ts#L66) |
