...
| <a id="sortby"></a> `sortBy?` | `"status"` \| `"priority"` \| `"createdAt"` \| `"updatedAt"` \| `"importance"` | [common/types/src/codeboltjstypes/libFunctionTypes/job.ts:81](common/types/src/codeboltjstypes/libFunctionTypes/job.ts#L81) |
