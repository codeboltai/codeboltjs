...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `team`: [`Team`](Team); \} | - | [common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:229](common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts#L229) |
| `data.team` | [`Team`](Team) | - | [common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:229](common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts#L229) |
