...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `result`: [`IngestionExecutionResult`](IngestionExecutionResult); \} | [`MemoryIngestionBaseResponse`](MemoryIngestionBaseResponse).[`data`](MemoryIngestionBaseResponse.md#data) | - | [common/types/src/codeboltjstypes/libFunctionTypes/memoryIngestion.ts:131](common/types/src/codeboltjstypes/libFunctionTypes/memoryIngestion.ts#L131) |
| `data.result` | [`IngestionExecutionResult`](IngestionExecutionResult) | - | - | [common/types/src/codeboltjstypes/libFunctionTypes/memoryIngestion.ts:131](common/types/src/codeboltjstypes/libFunctionTypes/memoryIngestion.ts#L131) |
