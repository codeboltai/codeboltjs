...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`AgentPortfolio`](AgentPortfolio) | Agent portfolio data - returned in 'data' property from cliLib | - | [common/types/src/codeboltjstypes/libFunctionTypes/agentPortfolio.ts:142](common/types/src/codeboltjstypes/libFunctionTypes/agentPortfolio.ts#L142) |
