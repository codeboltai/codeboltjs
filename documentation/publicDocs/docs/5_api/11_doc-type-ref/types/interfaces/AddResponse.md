...
Defined in: common/types/src/codeboltjstypes/libFunctionTypes/git.ts:56
...
| ------ | ------ | ------ | ------ |
| <a id="content"></a> `content?` | `string` | - | [common/types/src/codeboltjstypes/libFunctionTypes/git.ts:57](common/types/src/codeboltjstypes/libFunctionTypes/git.ts#L57) |
