...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`GitCommitSummary`](GitCommitSummary)[] | - | [common/types/src/codeboltjstypes/libFunctionTypes/git.ts:36](common/types/src/codeboltjstypes/libFunctionTypes/git.ts#L36) |
