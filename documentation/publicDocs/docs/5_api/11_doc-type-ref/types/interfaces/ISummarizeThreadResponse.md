...
| <a id="error"></a> `error?` | `string` | [`BaseApplicationResponse`](BaseApplicationResponse).[`error`](BaseApplicationResponse.md#error) | - | [common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:144](common/types/src/codeboltjstypes/libFunctionTypes/mail.ts#L144) |
...
| <a id="success"></a> `success?` | `boolean` | [`BaseApplicationResponse`](BaseApplicationResponse).[`success`](BaseApplicationResponse.md#success) | - | [common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:142](common/types/src/codeboltjstypes/libFunctionTypes/mail.ts#L142) |
| <a id="summary"></a> `summary?` | `string` | - | - | [common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:143](common/types/src/codeboltjstypes/libFunctionTypes/mail.ts#L143) |
