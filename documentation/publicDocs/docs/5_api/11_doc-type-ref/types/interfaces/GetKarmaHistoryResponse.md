...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`KarmaEntry`](KarmaEntry)[] | Karma history - returned in 'data' property from cliLib | - | [common/types/src/codeboltjstypes/libFunctionTypes/agentPortfolio.ts:176](common/types/src/codeboltjstypes/libFunctionTypes/agentPortfolio.ts#L176) |
