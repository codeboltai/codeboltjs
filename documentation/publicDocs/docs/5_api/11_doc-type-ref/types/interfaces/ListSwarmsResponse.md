...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `swarms`: [`Swarm`](Swarm)[]; \} | - | [common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:194](common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts#L194) |
| `data.swarms` | [`Swarm`](Swarm)[] | - | [common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:194](common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts#L194) |
