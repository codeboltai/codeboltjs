...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `count`: `number`; `events`: [`EventLogEntry`](EventLogEntry)[]; \} | [`EventLogBaseResponse`](EventLogBaseResponse).[`data`](EventLogBaseResponse.md#data) | - | [common/types/src/codeboltjstypes/libFunctionTypes/eventLog.ts:119](common/types/src/codeboltjstypes/libFunctionTypes/eventLog.ts#L119) |
| `data.count` | `number` | - | - | [common/types/src/codeboltjstypes/libFunctionTypes/eventLog.ts:119](common/types/src/codeboltjstypes/libFunctionTypes/eventLog.ts#L119) |
| `data.events` | [`EventLogEntry`](EventLogEntry)[] | - | - | [common/types/src/codeboltjstypes/libFunctionTypes/eventLog.ts:119](common/types/src/codeboltjstypes/libFunctionTypes/eventLog.ts#L119) |
