...
| <a id="todos"></a> `todos?` | [`TodoItem`](TodoItem)[] | Incomplete todo items | - | [common/types/src/codeboltjstypes/libFunctionTypes/todo.ts:77](common/types/src/codeboltjstypes/libFunctionTypes/todo.ts#L77) |
