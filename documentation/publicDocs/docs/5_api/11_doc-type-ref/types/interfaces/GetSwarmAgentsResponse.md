...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `agents`: [`SwarmAgent`](SwarmAgent)[]; \} | - | [common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:208](common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts#L208) |
| `data.agents` | [`SwarmAgent`](SwarmAgent)[] | - | [common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:208](common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts#L208) |
