...
| <a id="error"></a> `error?` | `string` | [`BaseApplicationResponse`](BaseApplicationResponse).[`error`](BaseApplicationResponse.md#error) | - | [common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:170](common/types/src/codeboltjstypes/libFunctionTypes/mail.ts#L170) |
...
| <a id="released"></a> `released?` | `boolean` | - | - | [common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:169](common/types/src/codeboltjstypes/libFunctionTypes/mail.ts#L169) |
...
| <a id="success"></a> `success?` | `boolean` | [`BaseApplicationResponse`](BaseApplicationResponse).[`success`](BaseApplicationResponse.md#success) | - | [common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:168](common/types/src/codeboltjstypes/libFunctionTypes/mail.ts#L168) |
