...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `swarm`: [`Swarm`](Swarm); \} | - | [common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:187](common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts#L187) |
| `data.swarm` | [`Swarm`](Swarm) | - | [common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:187](common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts#L187) |
