...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `groupId`: `string`; \} | - | [common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:365](common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts#L365) |
| `data.groupId` | `string` | - | [common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:365](common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts#L365) |
