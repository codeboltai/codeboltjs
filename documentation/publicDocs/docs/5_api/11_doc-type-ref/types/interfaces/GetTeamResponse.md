...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `members`: [`SwarmAgent`](SwarmAgent)[]; `team`: [`Team`](Team); \} | - | [common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:243](common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts#L243) |
| `data.members` | [`SwarmAgent`](SwarmAgent)[] | - | [common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:243](common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts#L243) |
| `data.team` | [`Team`](Team) | - | [common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:243](common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts#L243) |
