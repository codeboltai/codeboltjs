...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `message`: `string`; \} | - | [common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:299](common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts#L299) |
| `data.message` | `string` | - | [common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts:299](common/types/src/codeboltjstypes/libFunctionTypes/swarm.ts#L299) |
