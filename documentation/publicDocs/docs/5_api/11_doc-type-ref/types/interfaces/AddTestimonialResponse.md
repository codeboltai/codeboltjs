...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`Testimonial`](Testimonial) | Created testimonial data - returned in 'data' property from cliLib | - | [common/types/src/codeboltjstypes/libFunctionTypes/agentPortfolio.ts:152](common/types/src/codeboltjstypes/libFunctionTypes/agentPortfolio.ts#L152) |
