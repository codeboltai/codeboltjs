...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `instances`: [`EventLogInstance`](EventLogInstance)[]; \} | [`EventLogBaseResponse`](EventLogBaseResponse).[`data`](EventLogBaseResponse.md#data) | - | [common/types/src/codeboltjstypes/libFunctionTypes/eventLog.ts:111](common/types/src/codeboltjstypes/libFunctionTypes/eventLog.ts#L111) |
| `data.instances` | [`EventLogInstance`](EventLogInstance)[] | - | - | [common/types/src/codeboltjstypes/libFunctionTypes/eventLog.ts:111](common/types/src/codeboltjstypes/libFunctionTypes/eventLog.ts#L111) |
