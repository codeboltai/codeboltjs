...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`Talent`](Talent)[] | Talents list - returned in 'data' property from cliLib | - | [common/types/src/codeboltjstypes/libFunctionTypes/agentPortfolio.ts:196](common/types/src/codeboltjstypes/libFunctionTypes/agentPortfolio.ts#L196) |
