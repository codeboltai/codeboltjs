...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `pipeline`: [`IngestionPipeline`](IngestionPipeline); \} | [`MemoryIngestionBaseResponse`](MemoryIngestionBaseResponse).[`data`](MemoryIngestionBaseResponse.md#data) | - | [common/types/src/codeboltjstypes/libFunctionTypes/memoryIngestion.ts:123](common/types/src/codeboltjstypes/libFunctionTypes/memoryIngestion.ts#L123) |
| `data.pipeline` | [`IngestionPipeline`](IngestionPipeline) | - | - | [common/types/src/codeboltjstypes/libFunctionTypes/memoryIngestion.ts:123](common/types/src/codeboltjstypes/libFunctionTypes/memoryIngestion.ts#L123) |
