...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `enabled`: `boolean`; `name`: `string`; `tools?`: \{ `description?`: `string`; `name`: `string`; `parameters?`: `Record`\<`string`, `unknown`\>; \}[]; \}[] | - | [common/types/src/codeboltjstypes/libFunctionTypes/mcp.ts:190](common/types/src/codeboltjstypes/libFunctionTypes/mcp.ts#L190) |
