...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`Talent`](Talent) | Talent data - returned in 'data' property from cliLib | - | [common/types/src/codeboltjstypes/libFunctionTypes/agentPortfolio.ts:186](common/types/src/codeboltjstypes/libFunctionTypes/agentPortfolio.ts#L186) |
