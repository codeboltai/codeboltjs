...
| <a id="error"></a> `error?` | `string` | [`BaseApplicationResponse`](BaseApplicationResponse).[`error`](BaseApplicationResponse.md#error) | - | [common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:109](common/types/src/codeboltjstypes/libFunctionTypes/mail.ts#L109) |
...
| <a id="success"></a> `success?` | `boolean` | [`BaseApplicationResponse`](BaseApplicationResponse).[`success`](BaseApplicationResponse.md#success) | - | [common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:108](common/types/src/codeboltjstypes/libFunctionTypes/mail.ts#L108) |
