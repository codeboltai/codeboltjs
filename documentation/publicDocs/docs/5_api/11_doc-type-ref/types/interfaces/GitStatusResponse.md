...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`GitStatusData`](GitStatusData) | - | [common/types/src/codeboltjstypes/libFunctionTypes/git.ts:32](common/types/src/codeboltjstypes/libFunctionTypes/git.ts#L32) |
