...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `deletedCount`: `number`; \} | [`KVStoreBaseResponse`](KVStoreBaseResponse).[`data`](KVStoreBaseResponse.md#data) | - | [common/types/src/codeboltjstypes/libFunctionTypes/kvStore.ts:122](common/types/src/codeboltjstypes/libFunctionTypes/kvStore.ts#L122) |
| `data.deletedCount` | `number` | - | - | [common/types/src/codeboltjstypes/libFunctionTypes/kvStore.ts:122](common/types/src/codeboltjstypes/libFunctionTypes/kvStore.ts#L122) |
