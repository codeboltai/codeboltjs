...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`Testimonial`](Testimonial) | Updated testimonial data - returned in 'data' property from cliLib | - | [common/types/src/codeboltjstypes/libFunctionTypes/agentPortfolio.ts:157](common/types/src/codeboltjstypes/libFunctionTypes/agentPortfolio.ts#L157) |
