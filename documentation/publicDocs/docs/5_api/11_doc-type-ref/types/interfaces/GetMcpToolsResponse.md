...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `description?`: `string`; `name`: `string`; `parameters?`: `Record`\<`string`, `unknown`\>; \}[] | - | [common/types/src/codeboltjstypes/libFunctionTypes/mcp.ts:161](common/types/src/codeboltjstypes/libFunctionTypes/mcp.ts#L161) |
