...
| <a id="error"></a> `error?` | `string` | [`BaseApplicationResponse`](BaseApplicationResponse).[`error`](BaseApplicationResponse.md#error) | - | [common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:159](common/types/src/codeboltjstypes/libFunctionTypes/mail.ts#L159) |
...
| <a id="reservationid"></a> `reservationId?` | `string` | - | - | [common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:158](common/types/src/codeboltjstypes/libFunctionTypes/mail.ts#L158) |
| <a id="reserved"></a> `reserved?` | `boolean` | - | - | [common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:157](common/types/src/codeboltjstypes/libFunctionTypes/mail.ts#L157) |
| <a id="success"></a> `success?` | `boolean` | [`BaseApplicationResponse`](BaseApplicationResponse).[`success`](BaseApplicationResponse.md#success) | - | [common/types/src/codeboltjstypes/libFunctionTypes/mail.ts:156](common/types/src/codeboltjstypes/libFunctionTypes/mail.ts#L156) |
