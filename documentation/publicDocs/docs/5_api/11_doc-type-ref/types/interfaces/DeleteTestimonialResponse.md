...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `deleted`: `boolean`; \} | Deletion result - returned in 'data' property from cliLib | - | [common/types/src/codeboltjstypes/libFunctionTypes/agentPortfolio.ts:162](common/types/src/codeboltjstypes/libFunctionTypes/agentPortfolio.ts#L162) |
| `data.deleted` | `boolean` | - | - | [common/types/src/codeboltjstypes/libFunctionTypes/agentPortfolio.ts:162](common/types/src/codeboltjstypes/libFunctionTypes/agentPortfolio.ts#L162) |
