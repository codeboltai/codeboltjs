...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`AgentPortfolio`](AgentPortfolio) | Updated portfolio data - returned in 'data' property from cliLib | - | [common/types/src/codeboltjstypes/libFunctionTypes/agentPortfolio.ts:211](common/types/src/codeboltjstypes/libFunctionTypes/agentPortfolio.ts#L211) |
