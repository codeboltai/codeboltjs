...
Defined in: [packages/codeboltjs/src/types/swarm.ts:249](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/types/swarm.ts#L249)
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `message`: `string`; \} | - | [packages/codeboltjs/src/types/swarm.ts:250](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/types/swarm.ts#L250) |
| `data.message` | `string` | - | [packages/codeboltjs/src/types/swarm.ts:250](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/types/swarm.ts#L250) |
