...
Defined in: packages/codeboltjs/src/types/swarm.ts:200
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `swarm`: [`Swarm`](Swarm); \} | - | [packages/codeboltjs/src/types/swarm.ts:201](packages/codeboltjs/src/types/swarm.ts#L201) |
| `data.swarm` | [`Swarm`](Swarm) | - | [packages/codeboltjs/src/types/swarm.ts:201](packages/codeboltjs/src/types/swarm.ts#L201) |
