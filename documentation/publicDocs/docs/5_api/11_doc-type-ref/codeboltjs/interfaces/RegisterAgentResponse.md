...
Defined in: packages/codeboltjs/src/types/swarm.ts:214
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `agentId`: `string`; `swarmId`: `string`; \} | - | [packages/codeboltjs/src/types/swarm.ts:215](packages/codeboltjs/src/types/swarm.ts#L215) |
| `data.agentId` | `string` | - | [packages/codeboltjs/src/types/swarm.ts:215](packages/codeboltjs/src/types/swarm.ts#L215) |
| `data.swarmId` | `string` | - | [packages/codeboltjs/src/types/swarm.ts:215](packages/codeboltjs/src/types/swarm.ts#L215) |
