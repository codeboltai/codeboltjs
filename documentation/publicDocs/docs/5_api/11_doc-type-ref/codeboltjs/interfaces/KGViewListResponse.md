...
Defined in: packages/codeboltjs/src/types/knowledgeGraph.ts:214
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`KGView`](KGView)[] | [`KGBaseResponse`](KGBaseResponse).[`data`](KGBaseResponse.md#data) | - | [packages/codeboltjs/src/types/knowledgeGraph.ts:215](packages/codeboltjs/src/types/knowledgeGraph.ts#L215) |
