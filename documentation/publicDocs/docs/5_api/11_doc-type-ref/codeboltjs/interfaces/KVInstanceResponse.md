...
Defined in: packages/codeboltjs/src/types/kvStore.ts:101
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `instance`: [`KVStoreInstance`](KVStoreInstance); \} | [`KVStoreBaseResponse`](KVStoreBaseResponse).[`data`](KVStoreBaseResponse.md#data) | - | [packages/codeboltjs/src/types/kvStore.ts:102](packages/codeboltjs/src/types/kvStore.ts#L102) |
| `data.instance` | [`KVStoreInstance`](KVStoreInstance) | - | - | [packages/codeboltjs/src/types/kvStore.ts:102](packages/codeboltjs/src/types/kvStore.ts#L102) |
