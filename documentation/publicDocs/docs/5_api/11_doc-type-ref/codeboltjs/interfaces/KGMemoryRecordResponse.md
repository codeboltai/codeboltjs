...
Defined in: packages/codeboltjs/src/types/knowledgeGraph.ts:186
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`KGMemoryRecord`](KGMemoryRecord) | [`KGBaseResponse`](KGBaseResponse).[`data`](KGBaseResponse.md#data) | - | [packages/codeboltjs/src/types/knowledgeGraph.ts:187](packages/codeboltjs/src/types/knowledgeGraph.ts#L187) |
