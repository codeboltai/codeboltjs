...
Defined in: [packages/codeboltjs/src/types/swarm.ts:270](https://github.com/codeboltai/codeboltjs/blob/5bb856e41fe1f2472321cbac2497f5041bf947fb/packages/codeboltjs/src/types/swarm.ts#L270)
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `role`: [`Role`](Role); \} | - | [packages/codeboltjs/src/types/swarm.ts:271](https://github.com/codeboltai/codeboltjs/blob/5bb856e41fe1f2472321cbac2497f5041bf947fb/packages/codeboltjs/src/types/swarm.ts#L271) |
| `data.role` | [`Role`](Role) | - | [packages/codeboltjs/src/types/swarm.ts:271](https://github.com/codeboltai/codeboltjs/blob/5bb856e41fe1f2472321cbac2497f5041bf947fb/packages/codeboltjs/src/types/swarm.ts#L271) |
