...
Defined in: packages/codeboltjs/src/types/swarm.ts:221
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `message`: `string`; \} | - | [packages/codeboltjs/src/types/swarm.ts:222](packages/codeboltjs/src/types/swarm.ts#L222) |
| `data.message` | `string` | - | [packages/codeboltjs/src/types/swarm.ts:222](packages/codeboltjs/src/types/swarm.ts#L222) |
