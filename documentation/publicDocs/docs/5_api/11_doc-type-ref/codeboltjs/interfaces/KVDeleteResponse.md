...
Defined in: packages/codeboltjs/src/types/kvStore.ts:117
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `deleted`: `boolean`; \} | [`KVStoreBaseResponse`](KVStoreBaseResponse).[`data`](KVStoreBaseResponse.md#data) | - | [packages/codeboltjs/src/types/kvStore.ts:118](packages/codeboltjs/src/types/kvStore.ts#L118) |
| `data.deleted` | `boolean` | - | - | [packages/codeboltjs/src/types/kvStore.ts:118](packages/codeboltjs/src/types/kvStore.ts#L118) |
