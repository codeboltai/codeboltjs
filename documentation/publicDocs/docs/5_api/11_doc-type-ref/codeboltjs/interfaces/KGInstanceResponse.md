...
Defined in: packages/codeboltjs/src/types/knowledgeGraph.ts:178
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`KGInstance`](KGInstance) | [`KGBaseResponse`](KGBaseResponse).[`data`](KGBaseResponse.md#data) | - | [packages/codeboltjs/src/types/knowledgeGraph.ts:179](packages/codeboltjs/src/types/knowledgeGraph.ts#L179) |
