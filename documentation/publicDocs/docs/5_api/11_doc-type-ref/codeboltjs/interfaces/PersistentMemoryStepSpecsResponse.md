...
Defined in: packages/codeboltjs/src/types/persistentMemory.ts:100
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `specs`: `any`[]; \} | [`PersistentMemoryBaseResponse`](PersistentMemoryBaseResponse).[`data`](PersistentMemoryBaseResponse.md#data) | - | [packages/codeboltjs/src/types/persistentMemory.ts:101](packages/codeboltjs/src/types/persistentMemory.ts#L101) |
| `data.specs` | `any`[] | - | - | [packages/codeboltjs/src/types/persistentMemory.ts:101](packages/codeboltjs/src/types/persistentMemory.ts#L101) |
