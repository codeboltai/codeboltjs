...
Defined in: packages/codeboltjs/src/types/knowledgeGraph.ts:174
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`KGInstanceTemplate`](KGInstanceTemplate)[] | [`KGBaseResponse`](KGBaseResponse).[`data`](KGBaseResponse.md#data) | - | [packages/codeboltjs/src/types/knowledgeGraph.ts:175](packages/codeboltjs/src/types/knowledgeGraph.ts#L175) |
