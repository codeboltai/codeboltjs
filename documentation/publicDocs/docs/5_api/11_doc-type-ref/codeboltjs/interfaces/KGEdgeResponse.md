...
Defined in: packages/codeboltjs/src/types/knowledgeGraph.ts:194
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`KGEdge`](KGEdge) | [`KGBaseResponse`](KGBaseResponse).[`data`](KGBaseResponse.md#data) | - | [packages/codeboltjs/src/types/knowledgeGraph.ts:195](packages/codeboltjs/src/types/knowledgeGraph.ts#L195) |
