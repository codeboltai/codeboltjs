...
Defined in: packages/codeboltjs/src/types/memoryIngestion.ts:130
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `result`: [`IngestionExecutionResult`](IngestionExecutionResult); \} | [`MemoryIngestionBaseResponse`](MemoryIngestionBaseResponse).[`data`](MemoryIngestionBaseResponse.md#data) | - | [packages/codeboltjs/src/types/memoryIngestion.ts:131](packages/codeboltjs/src/types/memoryIngestion.ts#L131) |
| `data.result` | [`IngestionExecutionResult`](IngestionExecutionResult) | - | - | [packages/codeboltjs/src/types/memoryIngestion.ts:131](packages/codeboltjs/src/types/memoryIngestion.ts#L131) |
