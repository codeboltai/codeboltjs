...
Defined in: packages/codeboltjs/src/types/knowledgeGraph.ts:218
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | `any` | [`KGBaseResponse`](KGBaseResponse).[`data`](KGBaseResponse.md#data) | - | [packages/codeboltjs/src/types/knowledgeGraph.ts:219](packages/codeboltjs/src/types/knowledgeGraph.ts#L219) |
