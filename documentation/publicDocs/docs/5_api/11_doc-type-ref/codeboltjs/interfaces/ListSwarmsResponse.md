...
Defined in: packages/codeboltjs/src/types/swarm.ts:193
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `swarms`: [`Swarm`](Swarm)[]; \} | - | [packages/codeboltjs/src/types/swarm.ts:194](packages/codeboltjs/src/types/swarm.ts#L194) |
| `data.swarms` | [`Swarm`](Swarm)[] | - | [packages/codeboltjs/src/types/swarm.ts:194](packages/codeboltjs/src/types/swarm.ts#L194) |
