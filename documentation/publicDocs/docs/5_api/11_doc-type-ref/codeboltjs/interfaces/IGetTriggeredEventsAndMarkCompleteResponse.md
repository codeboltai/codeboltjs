...
| <a id="data"></a> `data?` | \{ `count`: `number`; `events`: [`CalendarEvent`](CalendarEvent)[]; \} | [`CalendarResponse`](CalendarResponse).[`data`](CalendarResponse.md#data) | - | [packages/codeboltjs/src/modules/calendar.ts:242](packages/codeboltjs/src/modules/calendar.ts#L242) |
| `data.count` | `number` | - | - | [packages/codeboltjs/src/modules/calendar.ts:244](packages/codeboltjs/src/modules/calendar.ts#L244) |
| `data.events` | [`CalendarEvent`](CalendarEvent)[] | - | - | [packages/codeboltjs/src/modules/calendar.ts:243](packages/codeboltjs/src/modules/calendar.ts#L243) |
