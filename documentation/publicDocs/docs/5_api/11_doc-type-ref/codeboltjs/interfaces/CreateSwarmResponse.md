...
Defined in: packages/codeboltjs/src/types/swarm.ts:186
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `swarm`: [`Swarm`](Swarm); \} | - | [packages/codeboltjs/src/types/swarm.ts:187](packages/codeboltjs/src/types/swarm.ts#L187) |
| `data.swarm` | [`Swarm`](Swarm) | - | [packages/codeboltjs/src/types/swarm.ts:187](packages/codeboltjs/src/types/swarm.ts#L187) |
