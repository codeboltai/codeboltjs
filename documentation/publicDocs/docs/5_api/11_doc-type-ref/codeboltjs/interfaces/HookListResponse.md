...
Defined in: packages/codeboltjs/src/types/hook.ts:78
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`Hook`](Hook)[] | [`HookBaseResponse`](HookBaseResponse).[`data`](HookBaseResponse.md#data) | - | [packages/codeboltjs/src/types/hook.ts:79](packages/codeboltjs/src/types/hook.ts#L79) |
