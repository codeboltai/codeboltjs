...
Defined in: packages/codeboltjs/src/types/knowledgeGraph.ts:202
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`KGViewTemplate`](KGViewTemplate) | [`KGBaseResponse`](KGBaseResponse).[`data`](KGBaseResponse.md#data) | - | [packages/codeboltjs/src/types/knowledgeGraph.ts:203](packages/codeboltjs/src/types/knowledgeGraph.ts#L203) |
