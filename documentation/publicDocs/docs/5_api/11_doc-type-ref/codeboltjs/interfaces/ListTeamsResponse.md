...
Defined in: packages/codeboltjs/src/types/swarm.ts:235
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `teams`: [`Team`](Team)[]; \} | - | [packages/codeboltjs/src/types/swarm.ts:236](packages/codeboltjs/src/types/swarm.ts#L236) |
| `data.teams` | [`Team`](Team)[] | - | [packages/codeboltjs/src/types/swarm.ts:236](packages/codeboltjs/src/types/swarm.ts#L236) |
