...
Defined in: packages/codeboltjs/src/types/swarm.ts:263
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `message`: `string`; \} | - | [packages/codeboltjs/src/types/swarm.ts:264](packages/codeboltjs/src/types/swarm.ts#L264) |
| `data.message` | `string` | - | [packages/codeboltjs/src/types/swarm.ts:264](packages/codeboltjs/src/types/swarm.ts#L264) |
