...
Defined in: packages/codeboltjs/src/types/eventLog.ts:122
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `result`: [`EventLogQueryResult`](EventLogQueryResult); \} | [`EventLogBaseResponse`](EventLogBaseResponse).[`data`](EventLogBaseResponse.md#data) | - | [packages/codeboltjs/src/types/eventLog.ts:123](packages/codeboltjs/src/types/eventLog.ts#L123) |
| `data.result` | [`EventLogQueryResult`](EventLogQueryResult) | - | - | [packages/codeboltjs/src/types/eventLog.ts:123](packages/codeboltjs/src/types/eventLog.ts#L123) |
