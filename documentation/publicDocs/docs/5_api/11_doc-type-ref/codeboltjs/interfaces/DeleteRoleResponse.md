...
Defined in: packages/codeboltjs/src/types/swarm.ts:312
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `message`: `string`; \} | - | [packages/codeboltjs/src/types/swarm.ts:313](packages/codeboltjs/src/types/swarm.ts#L313) |
| `data.message` | `string` | - | [packages/codeboltjs/src/types/swarm.ts:313](packages/codeboltjs/src/types/swarm.ts#L313) |
