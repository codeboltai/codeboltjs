...
Defined in: packages/codeboltjs/src/types/contextAssembly.ts:88
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `memoryTypes`: [`MemoryTypeSpec`](MemoryTypeSpec)[]; \} | [`ContextAssemblyBaseResponse`](ContextAssemblyBaseResponse).[`data`](ContextAssemblyBaseResponse.md#data) | - | [packages/codeboltjs/src/types/contextAssembly.ts:89](packages/codeboltjs/src/types/contextAssembly.ts#L89) |
| `data.memoryTypes` | [`MemoryTypeSpec`](MemoryTypeSpec)[] | - | - | [packages/codeboltjs/src/types/contextAssembly.ts:89](packages/codeboltjs/src/types/contextAssembly.ts#L89) |
