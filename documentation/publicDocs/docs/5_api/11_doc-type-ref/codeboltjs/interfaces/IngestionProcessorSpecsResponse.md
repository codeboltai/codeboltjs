...
Defined in: packages/codeboltjs/src/types/memoryIngestion.ts:138
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `specs`: `any`[]; \} | [`MemoryIngestionBaseResponse`](MemoryIngestionBaseResponse).[`data`](MemoryIngestionBaseResponse.md#data) | - | [packages/codeboltjs/src/types/memoryIngestion.ts:139](packages/codeboltjs/src/types/memoryIngestion.ts#L139) |
| `data.specs` | `any`[] | - | - | [packages/codeboltjs/src/types/memoryIngestion.ts:139](packages/codeboltjs/src/types/memoryIngestion.ts#L139) |
