...
Defined in: packages/codeboltjs/src/types/swarm.ts:333
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `message`: `string`; \} | - | [packages/codeboltjs/src/types/swarm.ts:334](packages/codeboltjs/src/types/swarm.ts#L334) |
| `data.message` | `string` | - | [packages/codeboltjs/src/types/swarm.ts:334](packages/codeboltjs/src/types/swarm.ts#L334) |
