...
Defined in: [packages/codeboltjs/src/modules/calendar.ts:254](https://github.com/codeboltai/codeboltjs/blob/5bb856e41fe1f2472321cbac2497f5041bf947fb/packages/codeboltjs/src/modules/calendar.ts#L254)
...
| <a id="data"></a> `data?` | \{ `isRunning`: `boolean`; `lastCheck`: `string`; `nextCheck`: `string`; `scheduledEvents`: `number`; \} | [`CalendarResponse`](CalendarResponse).[`data`](CalendarResponse.md#data) | - | [packages/codeboltjs/src/modules/calendar.ts:255](https://github.com/codeboltai/codeboltjs/blob/5bb856e41fe1f2472321cbac2497f5041bf947fb/packages/codeboltjs/src/modules/calendar.ts#L255) |
| `data.isRunning` | `boolean` | - | - | [packages/codeboltjs/src/modules/calendar.ts:256](https://github.com/codeboltai/codeboltjs/blob/5bb856e41fe1f2472321cbac2497f5041bf947fb/packages/codeboltjs/src/modules/calendar.ts#L256) |
| `data.lastCheck` | `string` | - | - | [packages/codeboltjs/src/modules/calendar.ts:257](https://github.com/codeboltai/codeboltjs/blob/5bb856e41fe1f2472321cbac2497f5041bf947fb/packages/codeboltjs/src/modules/calendar.ts#L257) |
| `data.nextCheck` | `string` | - | - | [packages/codeboltjs/src/modules/calendar.ts:258](https://github.com/codeboltai/codeboltjs/blob/5bb856e41fe1f2472321cbac2497f5041bf947fb/packages/codeboltjs/src/modules/calendar.ts#L258) |
| `data.scheduledEvents` | `number` | - | - | [packages/codeboltjs/src/modules/calendar.ts:259](https://github.com/codeboltai/codeboltjs/blob/5bb856e41fe1f2472321cbac2497f5041bf947fb/packages/codeboltjs/src/modules/calendar.ts#L259) |
