...
Defined in: packages/codeboltjs/src/types/eventLog.ts:118
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `count`: `number`; `events`: [`EventLogEntry`](EventLogEntry)[]; \} | [`EventLogBaseResponse`](EventLogBaseResponse).[`data`](EventLogBaseResponse.md#data) | - | [packages/codeboltjs/src/types/eventLog.ts:119](packages/codeboltjs/src/types/eventLog.ts#L119) |
| `data.count` | `number` | - | - | [packages/codeboltjs/src/types/eventLog.ts:119](packages/codeboltjs/src/types/eventLog.ts#L119) |
| `data.events` | [`EventLogEntry`](EventLogEntry)[] | - | - | [packages/codeboltjs/src/types/eventLog.ts:119](packages/codeboltjs/src/types/eventLog.ts#L119) |
