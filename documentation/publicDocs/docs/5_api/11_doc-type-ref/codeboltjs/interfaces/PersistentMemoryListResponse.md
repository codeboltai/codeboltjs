...
Defined in: packages/codeboltjs/src/types/persistentMemory.ts:88
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `memories`: [`PersistentMemory`](PersistentMemory)[]; \} | [`PersistentMemoryBaseResponse`](PersistentMemoryBaseResponse).[`data`](PersistentMemoryBaseResponse.md#data) | - | [packages/codeboltjs/src/types/persistentMemory.ts:89](packages/codeboltjs/src/types/persistentMemory.ts#L89) |
| `data.memories` | [`PersistentMemory`](PersistentMemory)[] | - | - | [packages/codeboltjs/src/types/persistentMemory.ts:89](packages/codeboltjs/src/types/persistentMemory.ts#L89) |
