...
Defined in: packages/codeboltjs/src/types/kvStore.ts:105
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `instances`: [`KVStoreInstance`](KVStoreInstance)[]; \} | [`KVStoreBaseResponse`](KVStoreBaseResponse).[`data`](KVStoreBaseResponse.md#data) | - | [packages/codeboltjs/src/types/kvStore.ts:106](packages/codeboltjs/src/types/kvStore.ts#L106) |
| `data.instances` | [`KVStoreInstance`](KVStoreInstance)[] | - | - | [packages/codeboltjs/src/types/kvStore.ts:106](packages/codeboltjs/src/types/kvStore.ts#L106) |
