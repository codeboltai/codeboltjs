...
Defined in: packages/codeboltjs/src/types/swarm.ts:291
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `message`: `string`; \} | - | [packages/codeboltjs/src/types/swarm.ts:292](packages/codeboltjs/src/types/swarm.ts#L292) |
| `data.message` | `string` | - | [packages/codeboltjs/src/types/swarm.ts:292](packages/codeboltjs/src/types/swarm.ts#L292) |
