...
Defined in: packages/codeboltjs/src/types/knowledgeGraph.ts:206
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`KGViewTemplate`](KGViewTemplate)[] | [`KGBaseResponse`](KGBaseResponse).[`data`](KGBaseResponse.md#data) | - | [packages/codeboltjs/src/types/knowledgeGraph.ts:207](packages/codeboltjs/src/types/knowledgeGraph.ts#L207) |
