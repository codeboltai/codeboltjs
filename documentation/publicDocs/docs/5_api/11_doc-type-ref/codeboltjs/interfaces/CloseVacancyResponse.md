...
Defined in: packages/codeboltjs/src/types/swarm.ts:340
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `message`: `string`; \} | - | [packages/codeboltjs/src/types/swarm.ts:341](packages/codeboltjs/src/types/swarm.ts#L341) |
| `data.message` | `string` | - | [packages/codeboltjs/src/types/swarm.ts:341](packages/codeboltjs/src/types/swarm.ts#L341) |
