...
Defined in: packages/codeboltjs/src/types/kvStore.ts:133
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `count`: `number`; \} | [`KVStoreBaseResponse`](KVStoreBaseResponse).[`data`](KVStoreBaseResponse.md#data) | - | [packages/codeboltjs/src/types/kvStore.ts:134](packages/codeboltjs/src/types/kvStore.ts#L134) |
| `data.count` | `number` | - | - | [packages/codeboltjs/src/types/kvStore.ts:134](packages/codeboltjs/src/types/kvStore.ts#L134) |
