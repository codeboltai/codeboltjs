...
Defined in: packages/codeboltjs/src/types/kvStore.ts:113
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `record`: [`KVRecord`](KVRecord); \} | [`KVStoreBaseResponse`](KVStoreBaseResponse).[`data`](KVStoreBaseResponse.md#data) | - | [packages/codeboltjs/src/types/kvStore.ts:114](packages/codeboltjs/src/types/kvStore.ts#L114) |
| `data.record` | [`KVRecord`](KVRecord) | - | - | [packages/codeboltjs/src/types/kvStore.ts:114](packages/codeboltjs/src/types/kvStore.ts#L114) |
