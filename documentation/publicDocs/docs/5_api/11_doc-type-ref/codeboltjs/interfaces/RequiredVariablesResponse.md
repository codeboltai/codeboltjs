...
Defined in: packages/codeboltjs/src/types/contextAssembly.ts:96
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`RequiredVariablesResult`](RequiredVariablesResult) | [`ContextAssemblyBaseResponse`](ContextAssemblyBaseResponse).[`data`](ContextAssemblyBaseResponse.md#data) | - | [packages/codeboltjs/src/types/contextAssembly.ts:97](packages/codeboltjs/src/types/contextAssembly.ts#L97) |
