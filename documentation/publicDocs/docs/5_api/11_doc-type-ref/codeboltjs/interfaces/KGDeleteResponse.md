...
Defined in: packages/codeboltjs/src/types/knowledgeGraph.ts:222
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `deleted`: `boolean`; \} | [`KGBaseResponse`](KGBaseResponse).[`data`](KGBaseResponse.md#data) | - | [packages/codeboltjs/src/types/knowledgeGraph.ts:223](packages/codeboltjs/src/types/knowledgeGraph.ts#L223) |
| `data.deleted` | `boolean` | - | - | [packages/codeboltjs/src/types/knowledgeGraph.ts:223](packages/codeboltjs/src/types/knowledgeGraph.ts#L223) |
