...
Defined in: packages/codeboltjs/src/types/contextAssembly.ts:84
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `validation`: [`ValidationResult`](ValidationResult); \} | [`ContextAssemblyBaseResponse`](ContextAssemblyBaseResponse).[`data`](ContextAssemblyBaseResponse.md#data) | - | [packages/codeboltjs/src/types/contextAssembly.ts:85](packages/codeboltjs/src/types/contextAssembly.ts#L85) |
| `data.validation` | [`ValidationResult`](ValidationResult) | - | - | [packages/codeboltjs/src/types/contextAssembly.ts:85](packages/codeboltjs/src/types/contextAssembly.ts#L85) |
