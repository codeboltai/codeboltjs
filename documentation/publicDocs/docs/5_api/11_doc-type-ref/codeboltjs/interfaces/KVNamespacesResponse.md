...
Defined in: packages/codeboltjs/src/types/kvStore.ts:129
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `namespaces`: `string`[]; \} | [`KVStoreBaseResponse`](KVStoreBaseResponse).[`data`](KVStoreBaseResponse.md#data) | - | [packages/codeboltjs/src/types/kvStore.ts:130](packages/codeboltjs/src/types/kvStore.ts#L130) |
| `data.namespaces` | `string`[] | - | - | [packages/codeboltjs/src/types/kvStore.ts:130](packages/codeboltjs/src/types/kvStore.ts#L130) |
