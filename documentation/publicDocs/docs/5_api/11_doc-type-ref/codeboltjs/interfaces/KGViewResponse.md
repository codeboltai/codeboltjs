...
Defined in: packages/codeboltjs/src/types/knowledgeGraph.ts:210
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`KGView`](KGView) | [`KGBaseResponse`](KGBaseResponse).[`data`](KGBaseResponse.md#data) | - | [packages/codeboltjs/src/types/knowledgeGraph.ts:211](packages/codeboltjs/src/types/knowledgeGraph.ts#L211) |
