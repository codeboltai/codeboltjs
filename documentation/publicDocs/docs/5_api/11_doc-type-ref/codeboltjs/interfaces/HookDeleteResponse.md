...
Defined in: packages/codeboltjs/src/types/hook.ts:86
...
| <a id="type"></a> `type` | `"hookDeleteResponse"` | [`HookBaseResponse`](HookBaseResponse).[`type`](HookBaseResponse.md#type) | - | [packages/codeboltjs/src/types/hook.ts:87](packages/codeboltjs/src/types/hook.ts#L87) |
