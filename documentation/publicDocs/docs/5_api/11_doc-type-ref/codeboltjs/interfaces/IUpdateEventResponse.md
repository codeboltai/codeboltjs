...
| <a id="data"></a> `data?` | \{ `event`: [`CalendarEvent`](CalendarEvent); \} | [`CalendarResponse`](CalendarResponse).[`data`](CalendarResponse.md#data) | - | [packages/codeboltjs/src/modules/calendar.ts:187](packages/codeboltjs/src/modules/calendar.ts#L187) |
| `data.event` | [`CalendarEvent`](CalendarEvent) | - | - | [packages/codeboltjs/src/modules/calendar.ts:188](packages/codeboltjs/src/modules/calendar.ts#L188) |
