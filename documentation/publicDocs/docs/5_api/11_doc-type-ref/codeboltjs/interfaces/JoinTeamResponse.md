...
Defined in: packages/codeboltjs/src/types/swarm.ts:249
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `message`: `string`; \} | - | [packages/codeboltjs/src/types/swarm.ts:250](packages/codeboltjs/src/types/swarm.ts#L250) |
| `data.message` | `string` | - | [packages/codeboltjs/src/types/swarm.ts:250](packages/codeboltjs/src/types/swarm.ts#L250) |
