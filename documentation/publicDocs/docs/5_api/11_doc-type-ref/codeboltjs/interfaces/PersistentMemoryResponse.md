...
Defined in: packages/codeboltjs/src/types/persistentMemory.ts:84
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `memory`: [`PersistentMemory`](PersistentMemory); \} | [`PersistentMemoryBaseResponse`](PersistentMemoryBaseResponse).[`data`](PersistentMemoryBaseResponse.md#data) | - | [packages/codeboltjs/src/types/persistentMemory.ts:85](packages/codeboltjs/src/types/persistentMemory.ts#L85) |
| `data.memory` | [`PersistentMemory`](PersistentMemory) | - | - | [packages/codeboltjs/src/types/persistentMemory.ts:85](packages/codeboltjs/src/types/persistentMemory.ts#L85) |
