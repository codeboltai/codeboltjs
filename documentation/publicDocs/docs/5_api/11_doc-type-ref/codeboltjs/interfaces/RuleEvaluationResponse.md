...
Defined in: packages/codeboltjs/src/types/contextAssembly.ts:92
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`RuleEvaluationResult`](RuleEvaluationResult) | [`ContextAssemblyBaseResponse`](ContextAssemblyBaseResponse).[`data`](ContextAssemblyBaseResponse.md#data) | - | [packages/codeboltjs/src/types/contextAssembly.ts:93](packages/codeboltjs/src/types/contextAssembly.ts#L93) |
