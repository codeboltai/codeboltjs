...
Defined in: packages/codeboltjs/src/types/kvStore.ts:121
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `deletedCount`: `number`; \} | [`KVStoreBaseResponse`](KVStoreBaseResponse).[`data`](KVStoreBaseResponse.md#data) | - | [packages/codeboltjs/src/types/kvStore.ts:122](packages/codeboltjs/src/types/kvStore.ts#L122) |
| `data.deletedCount` | `number` | - | - | [packages/codeboltjs/src/types/kvStore.ts:122](packages/codeboltjs/src/types/kvStore.ts#L122) |
