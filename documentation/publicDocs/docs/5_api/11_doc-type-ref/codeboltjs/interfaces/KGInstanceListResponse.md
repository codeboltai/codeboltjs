...
Defined in: packages/codeboltjs/src/types/knowledgeGraph.ts:182
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`KGInstance`](KGInstance)[] | [`KGBaseResponse`](KGBaseResponse).[`data`](KGBaseResponse.md#data) | - | [packages/codeboltjs/src/types/knowledgeGraph.ts:183](packages/codeboltjs/src/types/knowledgeGraph.ts#L183) |
