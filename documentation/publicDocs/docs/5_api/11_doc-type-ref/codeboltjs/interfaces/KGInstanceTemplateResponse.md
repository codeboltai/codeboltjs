...
Defined in: packages/codeboltjs/src/types/knowledgeGraph.ts:170
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`KGInstanceTemplate`](KGInstanceTemplate) | [`KGBaseResponse`](KGBaseResponse).[`data`](KGBaseResponse.md#data) | - | [packages/codeboltjs/src/types/knowledgeGraph.ts:171](packages/codeboltjs/src/types/knowledgeGraph.ts#L171) |
