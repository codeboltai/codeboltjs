...
Defined in: [packages/codeboltjs/src/modules/calendar.ts:180](https://github.com/codeboltai/codeboltjs/blob/5bb856e41fe1f2472321cbac2497f5041bf947fb/packages/codeboltjs/src/modules/calendar.ts#L180)
...
| <a id="data"></a> `data?` | \{ `event`: [`CalendarEvent`](CalendarEvent); \} | [`CalendarResponse`](CalendarResponse).[`data`](CalendarResponse.md#data) | - | [packages/codeboltjs/src/modules/calendar.ts:181](https://github.com/codeboltai/codeboltjs/blob/5bb856e41fe1f2472321cbac2497f5041bf947fb/packages/codeboltjs/src/modules/calendar.ts#L181) |
| `data.event` | [`CalendarEvent`](CalendarEvent) | - | - | [packages/codeboltjs/src/modules/calendar.ts:182](https://github.com/codeboltai/codeboltjs/blob/5bb856e41fe1f2472321cbac2497f5041bf947fb/packages/codeboltjs/src/modules/calendar.ts#L182) |
