...
Defined in: packages/codeboltjs/src/types/swarm.ts:305
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `agents`: [`SwarmAgent`](SwarmAgent)[]; \} | - | [packages/codeboltjs/src/types/swarm.ts:306](packages/codeboltjs/src/types/swarm.ts#L306) |
| `data.agents` | [`SwarmAgent`](SwarmAgent)[] | - | [packages/codeboltjs/src/types/swarm.ts:306](packages/codeboltjs/src/types/swarm.ts#L306) |
