...
Defined in: packages/codeboltjs/src/types/swarm.ts:284
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `assignees`: [`SwarmAgent`](SwarmAgent)[]; `role`: [`Role`](Role); \} | - | [packages/codeboltjs/src/types/swarm.ts:285](packages/codeboltjs/src/types/swarm.ts#L285) |
| `data.assignees` | [`SwarmAgent`](SwarmAgent)[] | - | [packages/codeboltjs/src/types/swarm.ts:285](packages/codeboltjs/src/types/swarm.ts#L285) |
| `data.role` | [`Role`](Role) | - | [packages/codeboltjs/src/types/swarm.ts:285](packages/codeboltjs/src/types/swarm.ts#L285) |
