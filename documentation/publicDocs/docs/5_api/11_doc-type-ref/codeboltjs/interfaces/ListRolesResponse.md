...
Defined in: [packages/codeboltjs/src/types/swarm.ts:277](https://github.com/codeboltai/codeboltjs/blob/5bb856e41fe1f2472321cbac2497f5041bf947fb/packages/codeboltjs/src/types/swarm.ts#L277)
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `roles`: [`Role`](Role)[]; \} | - | [packages/codeboltjs/src/types/swarm.ts:278](https://github.com/codeboltai/codeboltjs/blob/5bb856e41fe1f2472321cbac2497f5041bf947fb/packages/codeboltjs/src/types/swarm.ts#L278) |
| `data.roles` | [`Role`](Role)[] | - | [packages/codeboltjs/src/types/swarm.ts:278](https://github.com/codeboltai/codeboltjs/blob/5bb856e41fe1f2472321cbac2497f5041bf947fb/packages/codeboltjs/src/types/swarm.ts#L278) |
