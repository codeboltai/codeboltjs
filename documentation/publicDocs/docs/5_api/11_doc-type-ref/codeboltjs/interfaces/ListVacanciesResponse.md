...
Defined in: packages/codeboltjs/src/types/swarm.ts:326
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `vacancies`: [`Vacancy`](Vacancy)[]; \} | - | [packages/codeboltjs/src/types/swarm.ts:327](packages/codeboltjs/src/types/swarm.ts#L327) |
| `data.vacancies` | [`Vacancy`](Vacancy)[] | - | [packages/codeboltjs/src/types/swarm.ts:327](packages/codeboltjs/src/types/swarm.ts#L327) |
