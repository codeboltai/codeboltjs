...
Defined in: [packages/codeboltjs/src/types/swarm.ts:326](https://github.com/codeboltai/codeboltjs/blob/5bb856e41fe1f2472321cbac2497f5041bf947fb/packages/codeboltjs/src/types/swarm.ts#L326)
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `vacancies`: [`Vacancy`](Vacancy)[]; \} | - | [packages/codeboltjs/src/types/swarm.ts:327](https://github.com/codeboltai/codeboltjs/blob/5bb856e41fe1f2472321cbac2497f5041bf947fb/packages/codeboltjs/src/types/swarm.ts#L327) |
| `data.vacancies` | [`Vacancy`](Vacancy)[] | - | [packages/codeboltjs/src/types/swarm.ts:327](https://github.com/codeboltai/codeboltjs/blob/5bb856e41fe1f2472321cbac2497f5041bf947fb/packages/codeboltjs/src/types/swarm.ts#L327) |
