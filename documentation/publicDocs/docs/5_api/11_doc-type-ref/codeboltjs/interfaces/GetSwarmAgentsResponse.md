...
Defined in: packages/codeboltjs/src/types/swarm.ts:207
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `agents`: [`SwarmAgent`](SwarmAgent)[]; \} | - | [packages/codeboltjs/src/types/swarm.ts:208](packages/codeboltjs/src/types/swarm.ts#L208) |
| `data.agents` | [`SwarmAgent`](SwarmAgent)[] | - | [packages/codeboltjs/src/types/swarm.ts:208](packages/codeboltjs/src/types/swarm.ts#L208) |
