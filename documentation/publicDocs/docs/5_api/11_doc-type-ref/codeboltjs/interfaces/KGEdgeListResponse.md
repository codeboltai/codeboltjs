...
Defined in: packages/codeboltjs/src/types/knowledgeGraph.ts:198
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | [`KGEdge`](KGEdge)[] | [`KGBaseResponse`](KGBaseResponse).[`data`](KGBaseResponse.md#data) | - | [packages/codeboltjs/src/types/knowledgeGraph.ts:199](packages/codeboltjs/src/types/knowledgeGraph.ts#L199) |
