...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'browser_get_url'` | - | - | [packages/codeboltjs/src/tools/browser/get-url.ts:66](packages/codeboltjs/src/tools/browser/get-url.ts#L66) |
