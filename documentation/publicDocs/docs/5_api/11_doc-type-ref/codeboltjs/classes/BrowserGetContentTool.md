...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'browser_get_content'` | - | - | [packages/codeboltjs/src/tools/browser/get-content.ts:66](packages/codeboltjs/src/tools/browser/get-content.ts#L66) |
