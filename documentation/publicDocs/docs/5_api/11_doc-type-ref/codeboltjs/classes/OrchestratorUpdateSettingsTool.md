...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'orchestrator_update_settings'` | - | - | [packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts:76](packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts#L76) |
