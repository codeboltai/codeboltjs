...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'browser_search'` | - | - | [packages/codeboltjs/src/tools/browser/search.ts:69](packages/codeboltjs/src/tools/browser/search.ts#L69) |
