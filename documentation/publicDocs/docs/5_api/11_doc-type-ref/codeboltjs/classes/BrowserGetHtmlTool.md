...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'browser_get_html'` | - | - | [packages/codeboltjs/src/tools/browser/get-html.ts:66](packages/codeboltjs/src/tools/browser/get-html.ts#L66) |
