...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'thread_update_status'` | - | - | [packages/codeboltjs/src/tools/thread/thread-update-status.ts:66](packages/codeboltjs/src/tools/thread/thread-update-status.ts#L66) |
