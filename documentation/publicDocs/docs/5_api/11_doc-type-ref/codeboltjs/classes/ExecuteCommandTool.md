...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'execute_command'` | - | - | [packages/codeboltjs/src/tools/terminal/execute-command.ts:136](packages/codeboltjs/src/tools/terminal/execute-command.ts#L136) |
