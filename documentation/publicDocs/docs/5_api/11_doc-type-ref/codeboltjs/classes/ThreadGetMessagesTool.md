...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'thread_get_messages'` | - | - | [packages/codeboltjs/src/tools/thread/thread-get-messages.ts:91](packages/codeboltjs/src/tools/thread/thread-get-messages.ts#L91) |
