...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'agent_start'` | - | - | [packages/codeboltjs/src/tools/agent/agent-start.ts:74](packages/codeboltjs/src/tools/agent/agent-start.ts#L74) |
