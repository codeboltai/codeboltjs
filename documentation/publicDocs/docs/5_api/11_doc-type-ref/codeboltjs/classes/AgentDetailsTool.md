...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'agent_details'` | - | - | [packages/codeboltjs/src/tools/agent/agent-details.ts:91](packages/codeboltjs/src/tools/agent/agent-details.ts#L91) |
