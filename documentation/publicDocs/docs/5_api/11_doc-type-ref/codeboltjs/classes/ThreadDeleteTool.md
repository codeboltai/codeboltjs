...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'thread_delete'` | - | - | [packages/codeboltjs/src/tools/thread/thread-delete.ts:58](packages/codeboltjs/src/tools/thread/thread-delete.ts#L58) |
