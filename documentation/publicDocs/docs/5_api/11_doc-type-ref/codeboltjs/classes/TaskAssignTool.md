...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'task_assign'` | - | - | [packages/codeboltjs/src/tools/task/task-assign.ts:66](packages/codeboltjs/src/tools/task/task-assign.ts#L66) |
