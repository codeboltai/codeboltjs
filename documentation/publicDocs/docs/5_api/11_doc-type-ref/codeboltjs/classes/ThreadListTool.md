...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'thread_list'` | - | - | [packages/codeboltjs/src/tools/thread/thread-list.ts:66](packages/codeboltjs/src/tools/thread/thread-list.ts#L66) |
