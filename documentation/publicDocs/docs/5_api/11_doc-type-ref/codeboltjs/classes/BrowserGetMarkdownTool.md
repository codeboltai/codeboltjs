...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'browser_get_markdown'` | - | - | [packages/codeboltjs/src/tools/browser/get-markdown.ts:66](packages/codeboltjs/src/tools/browser/get-markdown.ts#L66) |
