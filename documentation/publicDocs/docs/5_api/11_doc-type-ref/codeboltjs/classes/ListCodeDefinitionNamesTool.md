...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'list_code_definition_names'` | - | - | [packages/codeboltjs/src/tools/search/list-code-definition-names.ts:116](packages/codeboltjs/src/tools/search/list-code-definition-names.ts#L116) |
