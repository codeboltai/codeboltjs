...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'read_many_files'` | - | - | [packages/codeboltjs/src/tools/file/read-many-files.ts:193](packages/codeboltjs/src/tools/file/read-many-files.ts#L193) |
