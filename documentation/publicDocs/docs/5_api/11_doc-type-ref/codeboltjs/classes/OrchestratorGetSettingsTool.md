...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'orchestrator_get_settings'` | - | - | [packages/codeboltjs/src/tools/orchestrator/orchestrator-get-settings.ts:62](packages/codeboltjs/src/tools/orchestrator/orchestrator-get-settings.ts#L62) |
