...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'thread_update'` | - | - | [packages/codeboltjs/src/tools/thread/thread-update.ts:66](packages/codeboltjs/src/tools/thread/thread-update.ts#L66) |
