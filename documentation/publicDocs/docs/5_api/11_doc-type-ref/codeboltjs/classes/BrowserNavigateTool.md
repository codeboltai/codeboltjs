...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'browser_navigate'` | - | - | [packages/codeboltjs/src/tools/browser/navigate.ts:67](packages/codeboltjs/src/tools/browser/navigate.ts#L67) |
