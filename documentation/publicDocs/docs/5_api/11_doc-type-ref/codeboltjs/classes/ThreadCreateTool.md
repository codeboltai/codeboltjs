...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'thread_create'` | - | - | [packages/codeboltjs/src/tools/thread/thread-create.ts:67](packages/codeboltjs/src/tools/thread/thread-create.ts#L67) |
