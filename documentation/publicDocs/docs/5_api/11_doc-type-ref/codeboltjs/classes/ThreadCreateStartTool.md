...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'thread_create_start'` | - | - | [packages/codeboltjs/src/tools/thread/thread-create-start.ts:67](packages/codeboltjs/src/tools/thread/thread-create-start.ts#L67) |
