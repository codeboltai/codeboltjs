...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'orchestrator_update_status'` | - | - | [packages/codeboltjs/src/tools/orchestrator/orchestrator-update-status.ts:68](packages/codeboltjs/src/tools/orchestrator/orchestrator-update-status.ts#L68) |
