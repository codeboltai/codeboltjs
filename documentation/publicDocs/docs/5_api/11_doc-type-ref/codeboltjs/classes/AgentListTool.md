...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'agent_list'` | - | - | [packages/codeboltjs/src/tools/agent/agent-list.ts:105](packages/codeboltjs/src/tools/agent/agent-list.ts#L105) |
