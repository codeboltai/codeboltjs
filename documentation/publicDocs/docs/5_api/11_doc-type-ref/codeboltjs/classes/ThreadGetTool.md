...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'thread_get'` | - | - | [packages/codeboltjs/src/tools/thread/thread-get.ts:66](packages/codeboltjs/src/tools/thread/thread-get.ts#L66) |
