...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'agent_find'` | - | - | [packages/codeboltjs/src/tools/agent/agent-find.ts:118](packages/codeboltjs/src/tools/agent/agent-find.ts#L118) |
