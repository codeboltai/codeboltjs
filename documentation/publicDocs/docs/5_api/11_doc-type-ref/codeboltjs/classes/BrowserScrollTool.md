...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'browser_scroll'` | - | - | [packages/codeboltjs/src/tools/browser/scroll.ts:69](packages/codeboltjs/src/tools/browser/scroll.ts#L69) |
