...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'ls'` | - | - | [packages/codeboltjs/src/tools/file/list-directory.ts:164](packages/codeboltjs/src/tools/file/list-directory.ts#L164) |
