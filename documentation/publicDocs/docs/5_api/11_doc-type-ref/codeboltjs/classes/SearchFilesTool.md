...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'search_files'` | - | - | [packages/codeboltjs/src/tools/search/search-files.ts:132](packages/codeboltjs/src/tools/search/search-files.ts#L132) |
