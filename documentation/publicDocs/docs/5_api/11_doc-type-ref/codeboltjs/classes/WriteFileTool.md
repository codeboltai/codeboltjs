...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'write_file'` | - | - | [packages/codeboltjs/src/tools/file/write-file.ts:104](packages/codeboltjs/src/tools/file/write-file.ts#L104) |
