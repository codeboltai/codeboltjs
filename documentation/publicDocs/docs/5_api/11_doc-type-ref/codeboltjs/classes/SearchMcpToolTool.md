...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'search_mcp_tool'` | - | - | [packages/codeboltjs/src/tools/search/search-mcp-tool.ts:120](packages/codeboltjs/src/tools/search/search-mcp-tool.ts#L120) |
