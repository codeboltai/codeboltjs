...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'task_delete'` | - | - | [packages/codeboltjs/src/tools/task/task-delete.ts:64](packages/codeboltjs/src/tools/task/task-delete.ts#L64) |
