...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'browser_screenshot'` | - | - | [packages/codeboltjs/src/tools/browser/screenshot.ts:81](packages/codeboltjs/src/tools/browser/screenshot.ts#L81) |
