...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'thread_create_background'` | - | - | [packages/codeboltjs/src/tools/thread/thread-create-background.ts:82](packages/codeboltjs/src/tools/thread/thread-create-background.ts#L82) |
