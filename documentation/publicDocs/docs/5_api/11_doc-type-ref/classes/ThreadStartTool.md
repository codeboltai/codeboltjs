...
Defined in: [packages/codeboltjs/src/tools/thread/thread-start.ts:63](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/thread/thread-start.ts#L63)
...
Defined in: [packages/codeboltjs/src/tools/thread/thread-start.ts:66](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/thread/thread-start.ts#L66)
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'thread_start'` | - | - | [packages/codeboltjs/src/tools/thread/thread-start.ts:64](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/thread/thread-start.ts#L64) |
...
Defined in: [packages/codeboltjs/src/tools/thread/thread-start.ts:92](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/thread/thread-start.ts#L92)
...
```ts
validateToolParams(params: ThreadStartParams): null | string;
```
...
```ts
protected validateToolParamValues(params: ThreadStartParams): null | string;
```

Defined in: [packages/codeboltjs/src/tools/thread/thread-start.ts:85](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/thread/thread-start.ts#L85)
