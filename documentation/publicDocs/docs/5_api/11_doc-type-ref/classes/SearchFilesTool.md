...
Defined in: [packages/codeboltjs/src/tools/search/search-files.ts:128](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/search/search-files.ts#L128)
...
Defined in: [packages/codeboltjs/src/tools/search/search-files.ts:134](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/search/search-files.ts#L134)
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'search_files'` | - | - | [packages/codeboltjs/src/tools/search/search-files.ts:132](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/search/search-files.ts#L132) |
...
Defined in: [packages/codeboltjs/src/tools/search/search-files.ts:194](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/search/search-files.ts#L194)
...
```ts
validateToolParams(params: SearchFilesToolParams): null | string;
```
...
```ts
protected validateToolParamValues(params: SearchFilesToolParams): null | string;
```

Defined in: [packages/codeboltjs/src/tools/search/search-files.ts:169](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/search/search-files.ts#L169)
