...
Defined in: [packages/codeboltjs/src/tools/browser/screenshot.ts:80](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/browser/screenshot.ts#L80)
...
Defined in: [packages/codeboltjs/src/tools/browser/screenshot.ts:83](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/browser/screenshot.ts#L83)
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'browser_screenshot'` | - | - | [packages/codeboltjs/src/tools/browser/screenshot.ts:81](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/browser/screenshot.ts#L81) |
...
Defined in: [packages/codeboltjs/src/tools/browser/screenshot.ts:119](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/browser/screenshot.ts#L119)
...
```ts
validateToolParams(params: BrowserScreenshotParams): null | string;
```
...
```ts
protected validateToolParamValues(_params: BrowserScreenshotParams): null | string;
```
