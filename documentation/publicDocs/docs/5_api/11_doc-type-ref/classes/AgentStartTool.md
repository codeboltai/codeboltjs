...
Defined in: [packages/codeboltjs/src/tools/agent/agent-start.ts:73](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/agent/agent-start.ts#L73)
...
Defined in: [packages/codeboltjs/src/tools/agent/agent-start.ts:76](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/agent/agent-start.ts#L76)
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'agent_start'` | - | - | [packages/codeboltjs/src/tools/agent/agent-start.ts:74](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/agent/agent-start.ts#L74) |
...
Defined in: [packages/codeboltjs/src/tools/agent/agent-start.ts:113](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/agent/agent-start.ts#L113)
...
```ts
validateToolParams(params: AgentStartParams): null | string;
```
...
```ts
protected validateToolParamValues(params: AgentStartParams): null | string;
```

Defined in: [packages/codeboltjs/src/tools/agent/agent-start.ts:103](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/agent/agent-start.ts#L103)
