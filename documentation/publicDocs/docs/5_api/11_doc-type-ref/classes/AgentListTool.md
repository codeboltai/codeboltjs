...
Defined in: [packages/codeboltjs/src/tools/agent/agent-list.ts:104](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/agent/agent-list.ts#L104)
...
Defined in: [packages/codeboltjs/src/tools/agent/agent-list.ts:107](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/agent/agent-list.ts#L107)
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'agent_list'` | - | - | [packages/codeboltjs/src/tools/agent/agent-list.ts:105](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/agent/agent-list.ts#L105) |
...
Defined in: [packages/codeboltjs/src/tools/agent/agent-list.ts:126](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/agent/agent-list.ts#L126)
...
```ts
validateToolParams(params: AgentListParams): null | string;
```
...
```ts
protected validateToolParamValues(_params: AgentListParams): null | string;
```
