...
Defined in: [modules/agentEventQueue.ts:143](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/modules/agentEventQueue.ts#L143)
...
> **checkForPendingExternalEvent**: () => `null` \| [`UnifiedExternalEvent`](../interfaces/UnifiedExternalEvent.md)
...
`null` \| [`UnifiedExternalEvent`](../interfaces/UnifiedExternalEvent.md)
...
> **getPendingExternalEvents**: () => [`UnifiedExternalEvent`](../interfaces/UnifiedExternalEvent.md)[]
...
[`UnifiedExternalEvent`](../interfaces/UnifiedExternalEvent.md)[]
...
> **waitForAnyExternalEvent**: () => `Promise`\<[`UnifiedExternalEvent`](../interfaces/UnifiedExternalEvent.md)\>
...
`Promise`\<[`UnifiedExternalEvent`](../interfaces/UnifiedExternalEvent.md)\>
