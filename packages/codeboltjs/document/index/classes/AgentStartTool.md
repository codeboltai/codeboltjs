...
[@codebolt/codeboltjs](../globals.md) / AgentStartTool

# Class: AgentStartTool

Defined in: [packages/codeboltjs/src/tools/agent/agent-start.ts:73](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/agent/agent-start.ts#L73)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`AgentStartParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/agent/agent-start.ts:76](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/agent/agent-start.ts#L76)
...
> `readonly` `static` **Name**: `string` = `'agent_start'`

Defined in: [packages/codeboltjs/src/tools/agent/agent-start.ts:74](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/agent/agent-start.ts#L74)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`AgentStartParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`AgentStartParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`AgentStartParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/agent/agent-start.ts:113](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/agent/agent-start.ts#L113)
...
Defined in: [packages/codeboltjs/src/tools/agent/agent-start.ts:103](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/agent/agent-start.ts#L103)
