...
[@codebolt/codeboltjs](../globals.md) / WriteFileTool

# Class: WriteFileTool

Defined in: [packages/codeboltjs/src/tools/file/write-file.ts:100](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/file/write-file.ts#L100)

Implementation of the WriteFile tool logic

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`WriteFileToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/file/write-file.ts:106](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/file/write-file.ts#L106)
...
> `readonly` `static` **Name**: `string` = `'write_file'`

Defined in: [packages/codeboltjs/src/tools/file/write-file.ts:104](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/file/write-file.ts#L104)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`WriteFileToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`WriteFileToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`WriteFileToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/file/write-file.ts:154](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/file/write-file.ts#L154)
...
Defined in: [packages/codeboltjs/src/tools/file/write-file.ts:135](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/file/write-file.ts#L135)
