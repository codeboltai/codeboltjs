...
[@codebolt/codeboltjs](../globals.md) / AgentDetailsTool

# Class: AgentDetailsTool

Defined in: [packages/codeboltjs/src/tools/agent/agent-details.ts:90](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/agent/agent-details.ts#L90)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`AgentDetailsParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/agent/agent-details.ts:93](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/agent/agent-details.ts#L93)
...
> `readonly` `static` **Name**: `string` = `'agent_details'`

Defined in: [packages/codeboltjs/src/tools/agent/agent-details.ts:91](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/agent/agent-details.ts#L91)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`AgentDetailsParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`AgentDetailsParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`AgentDetailsParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/agent/agent-details.ts:117](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/agent/agent-details.ts#L117)
