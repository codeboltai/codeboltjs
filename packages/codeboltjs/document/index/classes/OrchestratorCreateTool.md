...
[@codebolt/codeboltjs](../globals.md) / OrchestratorCreateTool

# Class: OrchestratorCreateTool

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-create.ts:79](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-create.ts#L79)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`OrchestratorCreateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-create.ts:82](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-create.ts#L82)
...
> `readonly` `static` **Name**: `string` = `'orchestrator_create'`

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-create.ts:80](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-create.ts#L80)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`OrchestratorCreateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
`OrchestratorCreateParams`

#### Returns

[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`OrchestratorCreateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`OrchestratorCreateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-create.ts:130](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-create.ts#L130)
...
Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-create.ts:117](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-create.ts#L117)
