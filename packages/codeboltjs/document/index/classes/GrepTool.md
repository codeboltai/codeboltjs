...
[@codebolt/codeboltjs](../globals.md) / GrepTool

# Class: GrepTool

Defined in: [packages/codeboltjs/src/tools/search/grep.ts:143](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/search/grep.ts#L143)

Implementation of the Grep tool logic

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`GrepToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/search/grep.ts:149](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/search/grep.ts#L149)
...
> `readonly` `static` **Name**: `string` = `'grep'`

Defined in: [packages/codeboltjs/src/tools/search/grep.ts:147](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/search/grep.ts#L147)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`GrepToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`GrepToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`GrepToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/search/grep.ts:212](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/search/grep.ts#L212)
...
Defined in: [packages/codeboltjs/src/tools/search/grep.ts:194](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/search/grep.ts#L194)
