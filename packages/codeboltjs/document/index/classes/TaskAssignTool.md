...
[@codebolt/codeboltjs](../globals.md) / TaskAssignTool

# Class: TaskAssignTool

Defined in: [packages/codeboltjs/src/tools/task/task-assign.ts:65](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-assign.ts#L65)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`TaskAssignParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/task/task-assign.ts:68](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-assign.ts#L68)
...
> `readonly` `static` **Name**: `string` = `'task_assign'`

Defined in: [packages/codeboltjs/src/tools/task/task-assign.ts:66](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-assign.ts#L66)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`TaskAssignParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`TaskAssignParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`TaskAssignParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/task/task-assign.ts:105](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-assign.ts#L105)
...
Defined in: [packages/codeboltjs/src/tools/task/task-assign.ts:95](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-assign.ts#L95)
