...
[@codebolt/codeboltjs](../globals.md) / BrowserNavigateTool

# Class: BrowserNavigateTool

Defined in: [packages/codeboltjs/src/tools/browser/navigate.ts:66](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/browser/navigate.ts#L66)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`BrowserNavigateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/browser/navigate.ts:69](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/browser/navigate.ts#L69)
...
> `readonly` `static` **Name**: `string` = `'browser_navigate'`

Defined in: [packages/codeboltjs/src/tools/browser/navigate.ts:67](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/browser/navigate.ts#L67)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`BrowserNavigateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`BrowserNavigateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`BrowserNavigateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/browser/navigate.ts:103](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/browser/navigate.ts#L103)
...
Defined in: [packages/codeboltjs/src/tools/browser/navigate.ts:96](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/browser/navigate.ts#L96)
