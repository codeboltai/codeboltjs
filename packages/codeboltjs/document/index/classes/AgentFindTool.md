...
[@codebolt/codeboltjs](../globals.md) / AgentFindTool

# Class: AgentFindTool

Defined in: [packages/codeboltjs/src/tools/agent/agent-find.ts:117](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/agent/agent-find.ts#L117)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`AgentFindParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/agent/agent-find.ts:120](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/agent/agent-find.ts#L120)
...
> `readonly` `static` **Name**: `string` = `'agent_find'`

Defined in: [packages/codeboltjs/src/tools/agent/agent-find.ts:118](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/agent/agent-find.ts#L118)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`AgentFindParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`AgentFindParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`AgentFindParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/agent/agent-find.ts:154](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/agent/agent-find.ts#L154)
...
Defined in: [packages/codeboltjs/src/tools/agent/agent-find.ts:147](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/agent/agent-find.ts#L147)
