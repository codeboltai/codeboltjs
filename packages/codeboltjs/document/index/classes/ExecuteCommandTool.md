...
[@codebolt/codeboltjs](../globals.md) / ExecuteCommandTool

# Class: ExecuteCommandTool

Defined in: [packages/codeboltjs/src/tools/terminal/execute-command.ts:132](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/terminal/execute-command.ts#L132)

Implementation of the ExecuteCommand tool logic

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`ExecuteCommandToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/terminal/execute-command.ts:138](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/terminal/execute-command.ts#L138)
...
> `readonly` `static` **Name**: `string` = `'execute_command'`

Defined in: [packages/codeboltjs/src/tools/terminal/execute-command.ts:136](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/terminal/execute-command.ts#L136)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ExecuteCommandToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ExecuteCommandToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ExecuteCommandToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/terminal/execute-command.ts:171](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/terminal/execute-command.ts#L171)
...
Defined in: [packages/codeboltjs/src/tools/terminal/execute-command.ts:161](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/terminal/execute-command.ts#L161)
