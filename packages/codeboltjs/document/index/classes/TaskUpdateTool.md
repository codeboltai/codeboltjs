...
[@codebolt/codeboltjs](../globals.md) / TaskUpdateTool

# Class: TaskUpdateTool

Defined in: [packages/codeboltjs/src/tools/task/task-update.ts:74](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-update.ts#L74)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`TaskUpdateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/task/task-update.ts:77](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-update.ts#L77)
...
> `readonly` `static` **Name**: `string` = `'task_update'`

Defined in: [packages/codeboltjs/src/tools/task/task-update.ts:75](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-update.ts#L75)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`TaskUpdateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`TaskUpdateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`TaskUpdateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/task/task-update.ts:119](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-update.ts#L119)
...
Defined in: [packages/codeboltjs/src/tools/task/task-update.ts:112](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-update.ts#L112)
