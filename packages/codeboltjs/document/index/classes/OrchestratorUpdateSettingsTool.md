...
[@codebolt/codeboltjs](../globals.md) / OrchestratorUpdateSettingsTool

# Class: OrchestratorUpdateSettingsTool

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts:75](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts#L75)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`OrchestratorUpdateSettingsParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts:78](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts#L78)
...
> `readonly` `static` **Name**: `string` = `'orchestrator_update_settings'`

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts:76](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts#L76)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`OrchestratorUpdateSettingsParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
`OrchestratorUpdateSettingsParams`

#### Returns

[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`OrchestratorUpdateSettingsParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`OrchestratorUpdateSettingsParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts:120](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts#L120)
...
Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts:113](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts#L113)
