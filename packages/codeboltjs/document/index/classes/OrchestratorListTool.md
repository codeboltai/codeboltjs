...
[@codebolt/codeboltjs](../globals.md) / OrchestratorListTool

# Class: OrchestratorListTool

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-list.ts:64](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-list.ts#L64)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`OrchestratorListParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-list.ts:67](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-list.ts#L67)
...
> `readonly` `static` **Name**: `string` = `'orchestrator_list'`

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-list.ts:65](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-list.ts#L65)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`OrchestratorListParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`OrchestratorListParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`OrchestratorListParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-list.ts:81](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-list.ts#L81)
