...
[@codebolt/codeboltjs](../globals.md) / TaskDeleteTool

# Class: TaskDeleteTool

Defined in: [packages/codeboltjs/src/tools/task/task-delete.ts:63](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-delete.ts#L63)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`TaskDeleteParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/task/task-delete.ts:66](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-delete.ts#L66)
...
> `readonly` `static` **Name**: `string` = `'task_delete'`

Defined in: [packages/codeboltjs/src/tools/task/task-delete.ts:64](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-delete.ts#L64)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`TaskDeleteParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`TaskDeleteParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`TaskDeleteParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/task/task-delete.ts:96](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-delete.ts#L96)
...
Defined in: [packages/codeboltjs/src/tools/task/task-delete.ts:89](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-delete.ts#L89)
