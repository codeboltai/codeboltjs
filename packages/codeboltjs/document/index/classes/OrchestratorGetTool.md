...
[@codebolt/codeboltjs](../globals.md) / OrchestratorGetTool

# Class: OrchestratorGetTool

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-get.ts:69](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-get.ts#L69)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`OrchestratorGetParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-get.ts:72](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-get.ts#L72)
...
> `readonly` `static` **Name**: `string` = `'orchestrator_get'`

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-get.ts:70](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-get.ts#L70)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`OrchestratorGetParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`OrchestratorGetParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`OrchestratorGetParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-get.ts:98](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-get.ts#L98)
...
Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-get.ts:91](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-get.ts#L91)
