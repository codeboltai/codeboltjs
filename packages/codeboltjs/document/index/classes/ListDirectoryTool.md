...
[@codebolt/codeboltjs](../globals.md) / ListDirectoryTool

# Class: ListDirectoryTool

Defined in: [packages/codeboltjs/src/tools/file/list-directory.ts:160](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/file/list-directory.ts#L160)

Implementation of the ListDirectory tool logic

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`ListDirectoryToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/file/list-directory.ts:166](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/file/list-directory.ts#L166)
...
> `readonly` `static` **Name**: `string` = `'ls'`

Defined in: [packages/codeboltjs/src/tools/file/list-directory.ts:164](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/file/list-directory.ts#L164)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ListDirectoryToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ListDirectoryToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ListDirectoryToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/file/list-directory.ts:231](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/file/list-directory.ts#L231)
...
Defined in: [packages/codeboltjs/src/tools/file/list-directory.ts:212](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/file/list-directory.ts#L212)
