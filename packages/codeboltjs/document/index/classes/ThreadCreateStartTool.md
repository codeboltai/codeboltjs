...
[@codebolt/codeboltjs](../globals.md) / ThreadCreateStartTool

# Class: ThreadCreateStartTool

Defined in: [packages/codeboltjs/src/tools/thread/thread-create-start.ts:66](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-create-start.ts#L66)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`ThreadCreateStartParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/thread/thread-create-start.ts:69](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-create-start.ts#L69)
...
> `readonly` `static` **Name**: `string` = `'thread_create_start'`

Defined in: [packages/codeboltjs/src/tools/thread/thread-create-start.ts:67](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-create-start.ts#L67)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ThreadCreateStartParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
`ThreadCreateStartParams`

#### Returns

[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ThreadCreateStartParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ThreadCreateStartParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/thread/thread-create-start.ts:95](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-create-start.ts#L95)
...
Defined in: [packages/codeboltjs/src/tools/thread/thread-create-start.ts:88](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-create-start.ts#L88)
