...
[@codebolt/codeboltjs](../globals.md) / ReadManyFilesTool

# Class: ReadManyFilesTool

Defined in: [packages/codeboltjs/src/tools/file/read-many-files.ts:189](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/file/read-many-files.ts#L189)

Implementation of the ReadManyFiles tool logic

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`ReadManyFilesToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/file/read-many-files.ts:195](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/file/read-many-files.ts#L195)
...
> `readonly` `static` **Name**: `string` = `'read_many_files'`

Defined in: [packages/codeboltjs/src/tools/file/read-many-files.ts:193](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/file/read-many-files.ts#L193)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ReadManyFilesToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ReadManyFilesToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ReadManyFilesToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/file/read-many-files.ts:276](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/file/read-many-files.ts#L276)
...
Defined in: [packages/codeboltjs/src/tools/file/read-many-files.ts:258](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/file/read-many-files.ts#L258)
