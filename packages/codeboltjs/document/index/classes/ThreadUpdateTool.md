...
[@codebolt/codeboltjs](../globals.md) / ThreadUpdateTool

# Class: ThreadUpdateTool

Defined in: [packages/codeboltjs/src/tools/thread/thread-update.ts:65](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-update.ts#L65)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`ThreadUpdateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/thread/thread-update.ts:68](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-update.ts#L68)
...
> `readonly` `static` **Name**: `string` = `'thread_update'`

Defined in: [packages/codeboltjs/src/tools/thread/thread-update.ts:66](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-update.ts#L66)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ThreadUpdateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ThreadUpdateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ThreadUpdateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/thread/thread-update.ts:101](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-update.ts#L101)
...
Defined in: [packages/codeboltjs/src/tools/thread/thread-update.ts:91](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-update.ts#L91)
