...
[@codebolt/codeboltjs](../globals.md) / ThreadUpdateStatusTool

# Class: ThreadUpdateStatusTool

Defined in: [packages/codeboltjs/src/tools/thread/thread-update-status.ts:65](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-update-status.ts#L65)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`ThreadUpdateStatusParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/thread/thread-update-status.ts:68](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-update-status.ts#L68)
...
> `readonly` `static` **Name**: `string` = `'thread_update_status'`

Defined in: [packages/codeboltjs/src/tools/thread/thread-update-status.ts:66](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-update-status.ts#L66)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ThreadUpdateStatusParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
`ThreadUpdateStatusParams`

#### Returns

[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ThreadUpdateStatusParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ThreadUpdateStatusParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/thread/thread-update-status.ts:101](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-update-status.ts#L101)
...
Defined in: [packages/codeboltjs/src/tools/thread/thread-update-status.ts:91](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-update-status.ts#L91)
