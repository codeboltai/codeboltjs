...
[@codebolt/codeboltjs](../globals.md) / OrchestratorUpdateTool

# Class: OrchestratorUpdateTool

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-update.ts:78](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-update.ts#L78)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`OrchestratorUpdateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-update.ts:81](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-update.ts#L81)
...
> `readonly` `static` **Name**: `string` = `'orchestrator_update'`

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-update.ts:79](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-update.ts#L79)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`OrchestratorUpdateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`OrchestratorUpdateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`OrchestratorUpdateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-update.ts:127](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-update.ts#L127)
...
Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-update.ts:120](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-update.ts#L120)
