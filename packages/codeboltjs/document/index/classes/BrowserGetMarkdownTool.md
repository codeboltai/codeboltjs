...
[@codebolt/codeboltjs](../globals.md) / BrowserGetMarkdownTool

# Class: BrowserGetMarkdownTool

Defined in: [packages/codeboltjs/src/tools/browser/get-markdown.ts:65](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/browser/get-markdown.ts#L65)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`BrowserGetMarkdownParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/browser/get-markdown.ts:68](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/browser/get-markdown.ts#L68)
...
> `readonly` `static` **Name**: `string` = `'browser_get_markdown'`

Defined in: [packages/codeboltjs/src/tools/browser/get-markdown.ts:66](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/browser/get-markdown.ts#L66)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`BrowserGetMarkdownParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
`BrowserGetMarkdownParams`

#### Returns

[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`BrowserGetMarkdownParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`BrowserGetMarkdownParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/browser/get-markdown.ts:91](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/browser/get-markdown.ts#L91)
