...
[@codebolt/codeboltjs](../globals.md) / TaskGetTool

# Class: TaskGetTool

Defined in: [packages/codeboltjs/src/tools/task/task-get.ts:75](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-get.ts#L75)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`TaskGetParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/task/task-get.ts:78](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-get.ts#L78)
...
> `readonly` `static` **Name**: `string` = `'task_get'`

Defined in: [packages/codeboltjs/src/tools/task/task-get.ts:76](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-get.ts#L76)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`TaskGetParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`TaskGetParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`TaskGetParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/task/task-get.ts:108](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-get.ts#L108)
...
Defined in: [packages/codeboltjs/src/tools/task/task-get.ts:101](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-get.ts#L101)
