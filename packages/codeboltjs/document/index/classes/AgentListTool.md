...
[@codebolt/codeboltjs](../globals.md) / AgentListTool

# Class: AgentListTool

Defined in: [packages/codeboltjs/src/tools/agent/agent-list.ts:104](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/agent/agent-list.ts#L104)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`AgentListParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/agent/agent-list.ts:107](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/agent/agent-list.ts#L107)
...
> `readonly` `static` **Name**: `string` = `'agent_list'`

Defined in: [packages/codeboltjs/src/tools/agent/agent-list.ts:105](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/agent/agent-list.ts#L105)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`AgentListParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`AgentListParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`AgentListParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/agent/agent-list.ts:126](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/agent/agent-list.ts#L126)
