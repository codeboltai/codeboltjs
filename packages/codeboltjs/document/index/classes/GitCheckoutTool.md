...
[@codebolt/codeboltjs](../globals.md) / GitCheckoutTool

# Class: GitCheckoutTool

Defined in: [packages/codeboltjs/src/tools/git/checkout.ts:68](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/git/checkout.ts#L68)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`GitCheckoutParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/git/checkout.ts:71](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/git/checkout.ts#L71)
...
> `readonly` `static` **Name**: `string` = `'git_checkout'`

Defined in: [packages/codeboltjs/src/tools/git/checkout.ts:69](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/git/checkout.ts#L69)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`GitCheckoutParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`GitCheckoutParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`GitCheckoutParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/git/checkout.ts:101](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/git/checkout.ts#L101)
...
Defined in: [packages/codeboltjs/src/tools/git/checkout.ts:94](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/git/checkout.ts#L94)
