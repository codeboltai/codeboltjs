...
[@codebolt/codeboltjs](../globals.md) / ThreadCreateBackgroundTool

# Class: ThreadCreateBackgroundTool

Defined in: [packages/codeboltjs/src/tools/thread/thread-create-background.ts:81](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-create-background.ts#L81)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`ThreadCreateBackgroundParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/thread/thread-create-background.ts:84](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-create-background.ts#L84)
...
> `readonly` `static` **Name**: `string` = `'thread_create_background'`

Defined in: [packages/codeboltjs/src/tools/thread/thread-create-background.ts:82](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-create-background.ts#L82)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ThreadCreateBackgroundParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
`ThreadCreateBackgroundParams`

#### Returns

[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ThreadCreateBackgroundParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ThreadCreateBackgroundParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/thread/thread-create-background.ts:131](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-create-background.ts#L131)
...
Defined in: [packages/codeboltjs/src/tools/thread/thread-create-background.ts:127](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-create-background.ts#L127)
