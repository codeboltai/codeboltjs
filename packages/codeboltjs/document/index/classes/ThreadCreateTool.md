...
[@codebolt/codeboltjs](../globals.md) / ThreadCreateTool

# Class: ThreadCreateTool

Defined in: [packages/codeboltjs/src/tools/thread/thread-create.ts:66](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-create.ts#L66)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`ThreadCreateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/thread/thread-create.ts:69](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-create.ts#L69)
...
> `readonly` `static` **Name**: `string` = `'thread_create'`

Defined in: [packages/codeboltjs/src/tools/thread/thread-create.ts:67](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-create.ts#L67)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ThreadCreateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ThreadCreateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ThreadCreateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/thread/thread-create.ts:95](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-create.ts#L95)
...
Defined in: [packages/codeboltjs/src/tools/thread/thread-create.ts:88](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/thread/thread-create.ts#L88)
