...
[@codebolt/codeboltjs](../globals.md) / GitLogsTool

# Class: GitLogsTool

Defined in: [packages/codeboltjs/src/tools/git/logs.ts:83](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/git/logs.ts#L83)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`GitLogsParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/git/logs.ts:86](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/git/logs.ts#L86)
...
> `readonly` `static` **Name**: `string` = `'git_logs'`

Defined in: [packages/codeboltjs/src/tools/git/logs.ts:84](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/git/logs.ts#L84)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`GitLogsParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`GitLogsParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`GitLogsParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/git/logs.ts:116](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/git/logs.ts#L116)
...
Defined in: [packages/codeboltjs/src/tools/git/logs.ts:109](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/git/logs.ts#L109)
