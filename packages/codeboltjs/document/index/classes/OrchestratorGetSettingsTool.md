...
[@codebolt/codeboltjs](../globals.md) / OrchestratorGetSettingsTool

# Class: OrchestratorGetSettingsTool

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-get-settings.ts:61](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-get-settings.ts#L61)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`OrchestratorGetSettingsParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-get-settings.ts:64](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-get-settings.ts#L64)
...
> `readonly` `static` **Name**: `string` = `'orchestrator_get_settings'`

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-get-settings.ts:62](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-get-settings.ts#L62)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`OrchestratorGetSettingsParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
`OrchestratorGetSettingsParams`

#### Returns

[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`OrchestratorGetSettingsParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`OrchestratorGetSettingsParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-get-settings.ts:90](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-get-settings.ts#L90)
...
Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-get-settings.ts:83](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-get-settings.ts#L83)
