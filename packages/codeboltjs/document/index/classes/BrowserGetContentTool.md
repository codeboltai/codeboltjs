...
[@codebolt/codeboltjs](../globals.md) / BrowserGetContentTool

# Class: BrowserGetContentTool

Defined in: [packages/codeboltjs/src/tools/browser/get-content.ts:65](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/browser/get-content.ts#L65)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`BrowserGetContentParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/browser/get-content.ts:68](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/browser/get-content.ts#L68)
...
> `readonly` `static` **Name**: `string` = `'browser_get_content'`

Defined in: [packages/codeboltjs/src/tools/browser/get-content.ts:66](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/browser/get-content.ts#L66)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`BrowserGetContentParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
`BrowserGetContentParams`

#### Returns

[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`BrowserGetContentParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`BrowserGetContentParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/browser/get-content.ts:91](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/browser/get-content.ts#L91)
