...
[@codebolt/codeboltjs](../globals.md) / TaskCreateTool

# Class: TaskCreateTool

Defined in: [packages/codeboltjs/src/tools/task/task-create.ts:79](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-create.ts#L79)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`TaskCreateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/task/task-create.ts:82](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-create.ts#L82)
...
> `readonly` `static` **Name**: `string` = `'task_create'`

Defined in: [packages/codeboltjs/src/tools/task/task-create.ts:80](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-create.ts#L80)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`TaskCreateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`TaskCreateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`TaskCreateParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/task/task-create.ts:120](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-create.ts#L120)
...
Defined in: [packages/codeboltjs/src/tools/task/task-create.ts:113](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/task/task-create.ts#L113)
