...
[@codebolt/codeboltjs](../globals.md) / ListCodeDefinitionNamesTool

# Class: ListCodeDefinitionNamesTool

Defined in: [packages/codeboltjs/src/tools/search/list-code-definition-names.ts:112](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/search/list-code-definition-names.ts#L112)

Implementation of the ListCodeDefinitionNames tool logic

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`ListCodeDefinitionNamesToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/search/list-code-definition-names.ts:118](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/search/list-code-definition-names.ts#L118)
...
> `readonly` `static` **Name**: `string` = `'list_code_definition_names'`

Defined in: [packages/codeboltjs/src/tools/search/list-code-definition-names.ts:116](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/search/list-code-definition-names.ts#L116)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ListCodeDefinitionNamesToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ListCodeDefinitionNamesToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`ListCodeDefinitionNamesToolParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/search/list-code-definition-names.ts:157](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/search/list-code-definition-names.ts#L157)
...
Defined in: [packages/codeboltjs/src/tools/search/list-code-definition-names.ts:143](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/search/list-code-definition-names.ts#L143)
