...
[@codebolt/codeboltjs](../globals.md) / OrchestratorUpdateStatusTool

# Class: OrchestratorUpdateStatusTool

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-update-status.ts:67](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-update-status.ts#L67)

Base class for declarative tools with built-in validation

## Extends

- [`BaseDeclarativeTool`](BaseDeclarativeTool.md)\<`OrchestratorUpdateStatusParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-update-status.ts:70](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-update-status.ts#L70)
...
> `readonly` `static` **Name**: `string` = `'orchestrator_update_status'`

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-update-status.ts:68](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-update-status.ts#L68)
...
> **build**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`OrchestratorUpdateStatusParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
`OrchestratorUpdateStatusParams`

#### Returns

[`ToolInvocation`](../interfaces/ToolInvocation.md)\<`OrchestratorUpdateStatusParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>
...
> `protected` **createInvocation**(`params`): [`ToolInvocation`](../interfaces/ToolInvocation.md)\<`OrchestratorUpdateStatusParams`, [`ToolFrameworkResult`](../interfaces/ToolFrameworkResult.md)\>

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-update-status.ts:108](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-update-status.ts#L108)
...
Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-update-status.ts:94](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/tools/orchestrator/orchestrator-update-status.ts#L94)
