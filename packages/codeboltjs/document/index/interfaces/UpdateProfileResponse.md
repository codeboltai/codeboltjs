...
[@codebolt/codeboltjs](../globals.md) / UpdateProfileResponse
...
> `optional` **data**: [`AgentPortfolio`](AgentPortfolio.md)

Defined in: common/types/dist/codeboltjstypes/libFunctionTypes/agentPortfolio.d.ts:184
