...
Defined in: [modules/swarm.ts:85](https://github.com/codeboltai/codeboltjs/blob/a8724faf1fbd91d41208870e38936af70f149d77/packages/codeboltjs/src/modules/swarm.ts#L85)
...
> **getDefaultJobGroup**: (`swarmId`) => `Promise`\<[`GetDefaultJobGroupResponse`](../interfaces/GetDefaultJobGroupResponse.md)\>
...
`Promise`\<[`GetDefaultJobGroupResponse`](../interfaces/GetDefaultJobGroupResponse.md)\>
