...
For detailed type usage examples, see [TYPES.md](_media/TYPES.md).
...
> **Note**: The `codeparsers` functions have been migrated to the `@codebolt/codeparser` package for better modularity. You can still access them through `codebolt.codeparsers` or import directly from `@codebolt/codeparser`. See [CODEPARSERS_MIGRATION.md](_media/CODEPARSERS_MIGRATION.md) for details.
...
- **[Type Definitions Guide](_media/TYPES.md)** - Comprehensive TypeScript usage guide
