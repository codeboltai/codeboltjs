...
Defined in: [packages/codeboltjs/src/tools/browser/get-url.ts:65](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/browser/get-url.ts#L65)
...
Defined in: [packages/codeboltjs/src/tools/browser/get-url.ts:68](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/browser/get-url.ts#L68)
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'browser_get_url'` | - | - | [packages/codeboltjs/src/tools/browser/get-url.ts:66](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/browser/get-url.ts#L66) |
...
Defined in: [packages/codeboltjs/src/tools/browser/get-url.ts:91](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/browser/get-url.ts#L91)
...
```ts
validateToolParams(params: BrowserGetUrlParams): null | string;
```
...
```ts
protected validateToolParamValues(_params: BrowserGetUrlParams): null | string;
```
