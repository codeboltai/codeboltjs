...
Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts:75](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts#L75)
...
Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts:78](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts#L78)
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'orchestrator_update_settings'` | - | - | [packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts:76](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts#L76) |
...
Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts:120](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts#L120)
...
```ts
validateToolParams(params: OrchestratorUpdateSettingsParams): null | string;
```
...
```ts
protected validateToolParamValues(params: OrchestratorUpdateSettingsParams): null | string;
```

Defined in: [packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts:113](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/orchestrator/orchestrator-update-settings.ts#L113)
