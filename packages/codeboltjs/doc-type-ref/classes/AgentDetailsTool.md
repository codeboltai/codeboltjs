...
Defined in: [packages/codeboltjs/src/tools/agent/agent-details.ts:90](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/agent/agent-details.ts#L90)
...
Defined in: [packages/codeboltjs/src/tools/agent/agent-details.ts:93](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/agent/agent-details.ts#L93)
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'agent_details'` | - | - | [packages/codeboltjs/src/tools/agent/agent-details.ts:91](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/agent/agent-details.ts#L91) |
...
Defined in: [packages/codeboltjs/src/tools/agent/agent-details.ts:117](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/agent/agent-details.ts#L117)
...
```ts
validateToolParams(params: AgentDetailsParams): null | string;
```
...
```ts
protected validateToolParamValues(_params: AgentDetailsParams): null | string;
```
