...
Defined in: [packages/codeboltjs/src/tools/task/task-execute.ts:65](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/task/task-execute.ts#L65)
...
Defined in: [packages/codeboltjs/src/tools/task/task-execute.ts:68](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/task/task-execute.ts#L68)
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'task_execute'` | - | - | [packages/codeboltjs/src/tools/task/task-execute.ts:66](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/task/task-execute.ts#L66) |
...
Defined in: [packages/codeboltjs/src/tools/task/task-execute.ts:105](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/task/task-execute.ts#L105)
...
```ts
validateToolParams(params: TaskExecuteParams): null | string;
```
...
```ts
protected validateToolParamValues(params: TaskExecuteParams): null | string;
```

Defined in: [packages/codeboltjs/src/tools/task/task-execute.ts:95](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/task/task-execute.ts#L95)
