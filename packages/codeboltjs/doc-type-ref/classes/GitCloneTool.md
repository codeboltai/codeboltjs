...
Defined in: [packages/codeboltjs/src/tools/git/clone.ts:73](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/git/clone.ts#L73)
...
Defined in: [packages/codeboltjs/src/tools/git/clone.ts:76](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/git/clone.ts#L76)
...
| <a id="name-1"></a> `Name` | `readonly` | `string` | `'git_clone'` | - | - | [packages/codeboltjs/src/tools/git/clone.ts:74](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/git/clone.ts#L74) |
...
Defined in: [packages/codeboltjs/src/tools/git/clone.ts:110](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/git/clone.ts#L110)
...
```ts
validateToolParams(params: GitCloneParams): null | string;
```
...
```ts
protected validateToolParamValues(params: GitCloneParams): null | string;
```

Defined in: [packages/codeboltjs/src/tools/git/clone.ts:103](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/tools/git/clone.ts#L103)
