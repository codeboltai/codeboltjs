...
Defined in: [packages/codeboltjs/src/types/memoryIngestion.ts:126](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/types/memoryIngestion.ts#L126)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `pipelines`: [`IngestionPipeline`](IngestionPipeline)[]; \} | [`MemoryIngestionBaseResponse`](MemoryIngestionBaseResponse).[`data`](MemoryIngestionBaseResponse.md#data) | - | [packages/codeboltjs/src/types/memoryIngestion.ts:127](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/types/memoryIngestion.ts#L127) |
| `data.pipelines` | [`IngestionPipeline`](IngestionPipeline)[] | - | - | [packages/codeboltjs/src/types/memoryIngestion.ts:127](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/types/memoryIngestion.ts#L127) |
