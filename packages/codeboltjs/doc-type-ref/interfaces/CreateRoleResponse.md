...
Defined in: [packages/codeboltjs/src/types/swarm.ts:270](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/types/swarm.ts#L270)
...
| ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `role`: [`Role`](Role); \} | - | [packages/codeboltjs/src/types/swarm.ts:271](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/types/swarm.ts#L271) |
| `data.role` | [`Role`](Role) | - | [packages/codeboltjs/src/types/swarm.ts:271](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/types/swarm.ts#L271) |
