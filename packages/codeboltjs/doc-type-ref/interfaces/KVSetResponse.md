...
Defined in: [packages/codeboltjs/src/types/kvStore.ts:113](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/types/kvStore.ts#L113)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="data"></a> `data?` | \{ `record`: [`KVRecord`](KVRecord); \} | [`KVStoreBaseResponse`](KVStoreBaseResponse).[`data`](KVStoreBaseResponse.md#data) | - | [packages/codeboltjs/src/types/kvStore.ts:114](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/types/kvStore.ts#L114) |
| `data.record` | [`KVRecord`](KVRecord) | - | - | [packages/codeboltjs/src/types/kvStore.ts:114](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/types/kvStore.ts#L114) |
