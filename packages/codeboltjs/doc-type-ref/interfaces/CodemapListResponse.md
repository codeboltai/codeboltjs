...
Defined in: [packages/codeboltjs/src/types/codemap.ts:75](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/types/codemap.ts#L75)
...
| <a id="data"></a> `data?` | \{ `codemaps`: [`CodemapInfo`](CodemapInfo)[]; `count`: `number`; \} | - | [packages/codeboltjs/src/types/codemap.ts:76](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/types/codemap.ts#L76) |
| `data.codemaps` | [`CodemapInfo`](CodemapInfo)[] | - | [packages/codeboltjs/src/types/codemap.ts:77](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/types/codemap.ts#L77) |
| `data.count` | `number` | - | [packages/codeboltjs/src/types/codemap.ts:78](https://github.com/codeboltai/codeboltjs/blob/36eac18c55e0c3027fd350e40230c8db1c7ff3af/packages/codeboltjs/src/types/codemap.ts#L78) |
